  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        canActivateChild: [AuthGuard],
        loadChildren: () =>
          import('../../../../libs/products/xn-vanke/src/lib/xn-vanke.module').then(
            (m) => m.XnVankeModule
          ),
      },
      {
      ...
      },
      {
        ...
        loadChildren: () =>
          import(
            'libs/products/huaqiaocheng-shanghai/src/lib/huaqiaocheng-shanghai.module'
          ).then((m) => m.HuaqiaochengShanghaiModule),
      },
      {
        path: 'oct',
        data: { name: '华侨城' },
      ...
      // 雅居乐-星顺（雅居乐改造项目）
      {
        ...
        canActivate: [AuthGuard],
        canActivateChild: [AuthGuard],
        loadChildren: () => import('../../../../libs/products/agile-xingshun/src/lib/agile-xingshun.module')
          .then(m => m.AgileXingshunModule),
      },
      // 雅居乐-恒泽（雅居乐改造项目）
      {
        path: 'agile-hz',
      ...
      // 账户体系
      {
        ...
        canActivate: [AuthGuard],
        canActivateChild: [AuthGuard],
        loadChildren: () => import('libs/products/account-system/src/lib/account-system.module').then((m) => m.AccountSystemModule),
      },
      // 成都轨交abs项目
      {
        path: 'abs-gj',
        ...
        canActivate: [AuthGuard],
        canActivateChild: [AuthGuard],
        loadChildren: () => import('../../../../libs/products/abs-gj/src/lib/abs-gj.module').then((m) => m.AbsGjModule),
      },
    ],
  },
  {
