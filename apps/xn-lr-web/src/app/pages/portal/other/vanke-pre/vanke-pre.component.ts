 ...
 ***************************************************************************/
 ...
 @Component({
    selector: 'app-vanke-pre',
    templateUrl: './vanke-pre.component.html',
    styleUrls: ['./vanke-pre.component.less']
  })
  export class VankePreComponent implements OnInit, AfterViewInit {
    current = 0
    navList = [
      {
        title: '产品要素',
    ...
    onDownload() {
      ...
      a.href = '/assets/lr/doc/vanke-pre/进度款前置融资业务申请书 20211214 LR.xlsx'
      a.click()
      a = null
    }
