...
export class ManageIntermediaryManagementComponent implements OnInit, AfterViewInit, OnDestroy {
    tabConfig: any;
  ...
  */
    ...
    getIntermediaryUserList(item) {
        ...
        this.xn.router.navigate(['/console/manage/intermediary/intermediary-user-list'], {
            queryParams: {
                paging: this.paging,
