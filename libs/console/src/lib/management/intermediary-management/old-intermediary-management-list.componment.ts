...
@Component({
    selector: 'app-old-intermediary-management-component',
    templateUrl: `./old-intermediary-management-list.componment.html`,
    styles: [`
    .item-box {
        position: relative;
        display: flex;
...
export class OldIntermediaryManagementComponent implements OnInit {
    tabConfig: any;
