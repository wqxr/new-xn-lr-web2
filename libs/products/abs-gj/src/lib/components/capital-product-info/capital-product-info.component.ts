 ...
 * All rights reserved.
 *
 * @file：libs\products\abs-gj\src\lib\components\capital-product-info\capital-product-info.component.ts
 * @summary：capital-product-info.component.ts
 * @version: 1.0
 * *************************************************************************
...
@Component({
  selector: 'lib-capital-product-info-gj',
  templateUrl: './capital-product-info.component.html',
  styleUrls: ['./capital-product-info.component.css']
})
export class GjCapitalProductInfoComponent implements OnInit, AfterViewInit, OnDestroy {
  @Input() params: any;
  ...
  formResize() {
    const scrollContainer = $(`<div class="custom-scrollbar" style="box-sizing: border-box;
            ...
            overflow: scroll;z-index: 1000;"></div>`).prependTo($('body'));
