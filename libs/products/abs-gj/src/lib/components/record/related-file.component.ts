 ...
 * All rights reserved.
 *
 * @file：libs\products\abs-gj\src\lib\components\record\vanke-related-file.component.ts
 * @summary：vanke-related-file.component.ts
 * @version: 1.0
 * *************************************************************************
...
@Component({
  selector: 'lib-file-related-gj',
  templateUrl: './related-file.component.html',
  styles: [
    `
      .table {
        font-size: 13px;
...
export class GjRelatedFileComponent implements OnInit {
  /** 列表数据 */
  data: any[] = [];
  heads: any[];
