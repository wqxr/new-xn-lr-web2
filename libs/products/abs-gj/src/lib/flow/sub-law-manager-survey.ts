 ...
 * All rights reserved.
 *
 * @file：libs\products\abs-gj\src\lib\flow\sub_law_manager_survey.ts
 * @summary：sub_law_manager_survey.ts
 * @version: 1.0
 * *************************************************************************
...
export class SubLawManagerSurvey implements IFlowCustom {
  ...
  afterSubmitandGettip(svrConfig: any): Observable<any> {
    ...
    } else if (svrConfig.procedure.procedureId === ProgressStep.Operate || svrConfig.procedure.procedureId === ProgressStep.Review) {
