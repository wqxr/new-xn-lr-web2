 ...
 * All rights reserved.
 *
 * @file：libs\products\abs-gj\src\lib\pages\assets-management\dragon-project-manager\dragon-capital-pool\dragon-capital-pool.ts
 * @summary：dragon-capital-pool.ts
 * @version: 1.0
 * *************************************************************************
...
export default class ProjectManagerCapitalList {
  ...
  static basicCapitalList = {
    ...
    searches: [
      ...
      {title: '资产编号', checkerId: 'poolTradeCode', type: 'text', required: false, sortOrder: 6, show: true},
      {
        ...
        options: {ref: 'dragonListTypesingle'}, required: false, sortOrder: 7, show: true
      },
      {
        title: '合同类型',
  ...
  static transactionFileList = {
    heads: [
      ...
      {label: '是否推送', value: 'projectSignStatus', type: 'projectSignStatus', show: true},
      {label: '资产编号', value: 'poolTradeCode', show: true},
    ...
    searches: [
      ...
      {title: '资产编号', checkerId: 'poolTradeCode', type: 'text', required: false, sortOrder: 6, show: true},
      {
        ...
        checkerId: 'flowId',
        type: 'select',
        options: {ref: 'dragonListTypesingle'},
        required: false,
        sortOrder: 7,
        show: true
      },
  ...
  static headSearches = {
    [TabValue.First]: {
      [SubTabValue.DOING]: ProjectManagerCapitalList.basicCapitalList
    },
    [TabValue.Second]: {
      [SubTabValue.DOING]: ProjectManagerCapitalList.transactionFileList
    },
    [TabValue.Third]: {
      [SubTabValue.DOING]: ProjectManagerCapitalList.dueDiligenceList
    },
    [TabValue.Fifth]: {
      [SubTabValue.DOING]: ProjectManagerCapitalList.specialCapitalList
    },
  };
    ...
    if (Object.prototype.toString.call(authInfo) === '[object Object]') {
      ...
      return authInfo.filter((tabObj: any) => {
        ...
        if (tabObj.hasOwnProperty(LevelEnum[tabObj.level]) && tabObj[LevelEnum[tabObj.level]]) {
          tabObj[LevelEnum[tabObj.level]] = ProjectManagerCapitalList
