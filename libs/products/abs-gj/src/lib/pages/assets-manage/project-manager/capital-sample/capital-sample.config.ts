 ...
 * All rights reserved.
 *
 * @file：libs\products\abs-gj\src\lib\pages\assets-manage\project-manager\capital-sample\capital-sample.config.ts
 * @summary：capital-sample.config.ts
 * @version: 1.0
 * *************************************************************************
...
export default class CapitalSampleConfig {
  ...
  static capitalSample = {
    checkers: [
      ...
      {
        title: '抽样结果',
        checkerId: 'sampleResult',
        type: 'sample-result-list',
        required: true,
        value: '',
        options: {},
        memo: '点击下载excel'
      },
      {
        ...
        childChecker: [
          {
            title: '笔数',
            checkerId: 'capitalCount',
            type: 'special-text',
            required: false,
            value: '',
            placeholder: '上方交易笔数汇总'
          },
          {
            title: '笔数占比',
            checkerId: 'capitalCountRatio',
            type: 'special-text',
            required: false,
            value: '',
            placeholder: '上方交易笔数汇总/资产池交易笔数'
          },
          {
            title: '金额',
            checkerId: 'capitalSum',
            type: 'special-text',
            required: false,
            value: '',
            placeholder: '上方交易应收账款金额汇总'
          },
          {
            title: '金额占比',
            checkerId: 'capitalSumRatio',
            type: 'special-text',
            required: false,
            value: '',
            placeholder: '上方交易应收账款金额汇总/资产池应收账款金额汇总'
          },
        ]
      },
