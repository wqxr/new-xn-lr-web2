 ...
 * All rights reserved.
 *
 * @file：libs\products\abs-gj\src\lib\pages\machine-list\machine-list.config.ts
 * @summary：machine-list.config.ts
 * @version: 1.0
 * *************************************************************************
...
import { FlowId, SubTabValue, TabValue } from 'libs/shared/src/lib/config/enum';
import { GjTradeStatusOptions } from 'libs/shared/src/lib/config/options/abs-gj.options';

/** 子标签页参数 */
export enum SubTabParam {
  /** 进行中 */
  DOING   = 1,
  /** 待还款 */
  TODO    = 2,
  ...
  static defaultConfig = {
    ...
    searches: [
      ...
      {title: '企业Id', checkerId: 'debtUnitId', type: 'text', required: false, sortOrder: 6},
      {
        ...
        checkerId: 'flowId',
        type: 'select',
        selectOptions: GjTradeStatusOptions,
        required: false,
        sortOrder: 6
      },
      {
          ...
          subTabList: [
            {
              ...
              edit: {
                ...
                rowButtons: [
                  {
                    label: '中止交易', operate: 'stop',
                    click: (params, xn: XnService) => {
                      xn.router.navigate([`/abs-gj/record/new/${FlowId.CMNStop}`],
                        {
                          queryParams: {
                            id: FlowId.CMNStop,
                            relate: 'mainFlowId',
                  ...
                  {
                    label: '修改预录入信息', operate: 'changeInfo',
                    click: (params, xn: XnService) => {
                      xn.router.navigate([`/abs-gj/record/new/${FlowId.CMNPreChange}`],
                        {
                          queryParams: {
                            id: FlowId.CMNPreChange,
                            relate: 'mainFlowId',
                            relateValue: params.mainFlowId,
                          }
                        });
                  ...
                  {label: '新增备注', operate: 'addMark'},
                ]
              },
              searches: [...MachineIndexTabConfig.defaultConfig.searches,
                {
              ...
              headText: [...MachineIndexTabConfig.defaultConfig.heads,
            ...
            {
              label: '已完成',
              value: SubTabValue.TODO,
              canSearch: true,
              canChecked: true,
              params: SubTabParam.TODO,
              edit: {
                headButtons: [
                  ...MachineIndexTabConfig.baseHeadButtons,
                  {
          ...
          subTabList: [
            {
              ...
              searches: MachineIndexTabConfig.otherConfig.searches,
              headText: [...MachineIndexTabConfig.otherConfig.heads,
                ...
                {label: '付款确认书文件(总部致保理商)', value: 'pdfProjectFiles', type: 'file', },
                {label: 'remark', value: 'remark', type: 'remark', }
