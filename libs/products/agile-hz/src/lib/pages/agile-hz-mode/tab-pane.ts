...
export default class TabConfig {
  ...
  static addInfo = {
    ...
    searches: [
      ...
      },
      {
        ...
        required: false,
        sortOrder: 2,
        options: {ref: 'agileXingshunTradeStatus'},
      },
      {
        title: '收款单位名称',
        checkerId: 'debtUnit',
  ...
  static receiptList = {
    heads: [
      ...
      {label: '交易状态', value: 'flowId', type: 'agileXingshunTradeStatus'},
      ...
      {
        label: '《付款确认书（适用于雅居乐下属公司向供应商出具）》', value: 'second_yjl_xs_01_contract',
        bodyContractYyj: 'second_yjl_xs_01_contractStatus', templateFlag: 'second_yjl_xs_01', type: 'contract'
      },
      {
        label: '《应收账款转让通知书回执（适用于雅居乐下属公司向供应商出具）》', value: 'second_yjl_xs_03_contract',
        bodyContractYyj: 'second_yjl_xs_03_contractStatus', templateFlag: 'second_yjl_xs_03', type: 'contract'
      },
      {
        label: '《应收账款转让通知书回执（适用于雅居乐下属公司向保理商出具）》', value: 'second_yjl_xs_07_contract',
        bodyContractYyj: 'second_yjl_xs_07_contractStatus', templateFlag: 'second_yjl_xs_07', type: 'contract'
      },
      {
        label: '《应收账款转让通知书（适用于保理商向雅居乐下属公司出具）》', value: 'second_yjl_xs_05_contract',
        bodyContractYyj: 'second_yjl_xs_05_contractStatus', templateFlag: 'second_yjl_xs_05', type: 'contract'
      },
