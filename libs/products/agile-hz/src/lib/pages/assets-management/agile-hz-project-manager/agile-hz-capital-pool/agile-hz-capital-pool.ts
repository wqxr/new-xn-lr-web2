...
export default class ProjectManagerCapitalList {
    ...
    static basicCapitalList = {
        heads: <ListHeadsFieldOutputModel[]>[
            ...
            { label: '是否有履约证明', value: 'isPerformance', type: 'projectSignStatus', _inList: { sort: false, search: true }, show: true },
        ],
        searches: <CheckersOutputModel[]>[
            ...
            { title: '交易状态', checkerId: 'flowId', type: 'select', options: { ref: 'agileXingshunTradeStatus' }, required: false, sortOrder: 7, show: true },
            ...
            { title: '是否有履约证明', checkerId: 'isPerformance', type: 'select', options: { ref: 'defaultRadio' }, required: false, sortOrder: 15, show: true },
        ]
    };
    ...
    static transactionFileList = {
        heads: <ListHeadsFieldOutputModel[]>[
            ...
            { label: '付款确认书编号', value: 'payConfirmId', show: true },
        ...
        searches: <CheckersOutputModel[]>[
            ...
            { title: '是否推送', checkerId: 'projectSignStatus', base: 'number', type: 'select', options: { ref: 'defaultRadio' }, required: false, sortOrder: 18, show: true },
    ...
    static businessDetails = {
        checkers: <any[]>[
            ...
            { label: '合同类型', value: 'contractType', type: 'contractType', data: '' },
