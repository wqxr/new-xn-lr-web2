...
@Component({
    selector: 'agile-hz-project-management-component',
    templateUrl: `./agile-hz-project-management.component.html`,
    styles: [`
    .item-box {
        position: relative;
        display: flex;
    ...
    public handleRowClick(item: any, btn: ButtonConfigModel, i: number) {
        ...
        switch (btn.operate) {
            ...
            case 'notice_manage':  // 提醒管理
                this.xn.router.navigate(['/agile-hz/assets-management/notice-manage'], {
                    queryParams: {
                        project_manage_id: item.project_manage_id,
                        projectName: item.projectName
                    }
