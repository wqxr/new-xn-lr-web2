 ...
 * @summary：雅居乐-恒泽-项目管理-专项计划列表
 * @version: 1.0
 * **********************************************************************
 * revision             author            reason             date
 * 1.0                hucongying        雅居乐-恒泽数据对接     2020-11-03
 * **********************************************************************
 */
...
import ProjectManagerplanList from './agile-hz-project-plan';

declare const moment: any;
declare const $: any;

@Component({
    selector: 'agile-hz-project-plan-list',
    templateUrl: `./agile-hz-project-plan-list.component.html`,
    styles: [`
    .item-box {
        position: relative;
        display: flex;
...
export class ProjectmanagePlanComponent implements OnInit {
    tabConfig: any;
    ...
    ngOnInit(): void {
        this.router.queryParams.subscribe(x => {
            this.title = '项目管理-雅居乐-恒泽>' + x.title + '>' + x.projectName + '-' + x.headquarters;
  ...
  */
     ...
     */
    navBack() {
        this.xn.router.navigate(['/agile-hz/assets-management/project-list'], {
            queryParams: {
