...
// 标准保理 - 交易列表
export default class EnterPoolConfig {
    // 地产类ABS
    static enterPoolList = {
        ...
        searches: [
            ...
            { title: '交易状态', checkerId: 'tradeStatus', type: 'select', required: false, sortOrder: 5, options: { ref: 'agileXingshunTradeStatus' }, },
            ...
            tabList: [
                {
                    ...
                    searches: EnterPoolConfig.enterPoolList.searches,
                    headText: EnterPoolConfig.enterPoolList.heads,
