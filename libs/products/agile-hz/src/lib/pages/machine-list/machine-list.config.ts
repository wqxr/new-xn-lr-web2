 ...
 * 1.0                 hucongying       雅居乐-恒泽台账列表      2020-10-26
 * **********************************************************************
 */
...
export default class MachineIndexTabConfig {
  ...
  static MachineaccountTab = {
    ...
    searches: [
      ...
      {
        title: '中登登记状态',
        checkerId: 'zhongdengStatus',
        type: 'select',
        options: { ref: 'zhongdengStatus' },
        required: false,
        sortOrder: 3,
      },
      {
...

      {
        ...
        options: { ref: 'machineAgileXingshunTradeStatus' },
        required: false,
        sortOrder: 6,
      },
      {
        title: '供应商是否注册',
        checkerId: 'isRegisterSupplier',
        type: 'select',
        required: false,
        sortOrder: 7,
        options: { ref: 'isInit' },
      ...
      {
        title: '律所是否抽查',
        checkerId: 'isLawOfficeCheck',
        type: 'select',
        options: { ref: 'isLawOfficeCheck' },
        required: false,
        sortOrder: 12,
      },
      {
      ...
      {
        title: '入池建议类型',
        checkerId: 'poolAdviseType',
        type: 'select',
        options: { ref: 'poolAdviseType' },
        required: false,
      },
      {
        title: '审核优先级',
          ...
          subTabList: [
            {
              ...
              searches: [
                ...MachineIndexTabConfig.MachineaccountTab.searches,
                {
                  title: '渠道',
                ...
                {
                  title: '补充协议流程状态',
                  checkerId: 'addContractStatus',
                  type: 'select',
                  options: { ref: 'supplementaryAgreement' },
                  required: false,
                  sortOrder: 14,
                },
              ],
              headText: [
                ...MachineIndexTabConfig.MachineaccountTab.heads,
                {
                  label: '是否补充到期日',
                  value: 'isFactoringEndDate',
                  type: 'defaultRadio',
                  width: '5%',
                },
                {
                ...
                {
                  label: '中登状态',
                  value: 'zhongdengStatus',
                  type: 'zhongdengStatus',
                  _inList: {
                    sort: true,
                    search: true,
                  },
            ...
            },
            {
              ...
              params: 3,
              edit: {
                headButtons: [...MachineIndexTabConfig.baseHeadButtons],
                rowButtons: [
                  {
                    label: '新增备注',
                    operate: 'addMark',
                ...
                rowButtons: [
                  {
                    ...
                    click: (
                      ...
                      hwModeService.AgileHzViewProcess(
                        params.mainFlowId,
                        params.isProxy
                      );
                    },
          ...
          subTabList: [
            {
              ...
              headText: [
                ...MachineIndexTabConfig.suppliermachineAccount.heads,
