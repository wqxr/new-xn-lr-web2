 ...
 * All rights reserved.
 *
 * @file：PaymentTabConfig
 * @summary：雅居乐-恒泽 上传付款确认书列表配置
 * @version: 1.0
 * **********************************************************************
...
export default class PaymentTabConfig {
  // 列表默认配置
  static baseList = {
    heads: [
          ...
          subTabList: [
            {
              ...
              searches: PaymentTabConfig.baseList.searches,
              params: 0,
              headText: [
                ...PaymentTabConfig.baseList.heads,
                {
                  label: '付款确认书影印件',
