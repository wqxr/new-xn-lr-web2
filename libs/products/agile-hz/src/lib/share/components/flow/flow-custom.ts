...
import { AgileHzFinancingPre } from './agile_hz_financing_pre';
import { AgileHzFinancing } from './agile_hz_financing';
...
export class FlowCustom {
    ...
    static build(
        ...
        switch (name) {
            ...
            // 雅居乐-恒泽-发起提单
            case 'yjl_financing_pre':
                return new AgileHzFinancingPre(xn);
            // 雅居乐-恒泽-供应商上传资料
            case 'yjl_financing':
                return new AgileHzFinancing(xn, loading);
            // 雅居乐-恒泽-平台审核
            case 'yjl_platform_verify':
                return new AgilePlatformVerify(xn, loading);
            // 雅居乐-恒泽-保理商风险审核
            case 'yjl_factoring_risk':
                return new AgileFactoringRisk(xn, loading);
            // 雅居乐-恒泽-供应商签署合同
            case 'yjl_financing_sign':
                return new AgileFinancingSign(xn, loading, localservice);
            // 雅居乐-恒泽-保理商回传合同
            case 'yjl_factoring_passback':
