...
import Infos, { HeadsStyle, TableStyle } from './checkers.tab';
...
@DynamicForm({ type: 'table-common-yjl', formModule: 'dragon-input' })
export class TableInfoInputComponent implements OnInit {
    ...
    ngOnInit() {
        this.TabConfig = Infos[this.row.checkerId];
