...
@Component({
    ...
    <div style='width:100%'>
        ...
        <table class="table-hover table table-bordered file-row-table" style="border:0;cellspacing:0;cellpadding:0">
            ...
            {{items.changeReason |xnSelectTransform:'changeReasonYjl' }}
          </span>
            </td>
            </tr>
            </table>
...
@DynamicForm({ type: 'compare-info-yjl', formModule: 'avenger-show' })
export class AvengerCompareInfoYjlComponent implements OnInit {
    @Input() row: any;
