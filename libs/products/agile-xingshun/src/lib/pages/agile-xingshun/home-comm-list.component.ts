 ...
 * @summary：新雅居乐-星顺-[代办列表]
 * @version: 1.0
 * **********************************************************************
 * revision             author            reason             date
 * 1.0                hucongying        雅居乐-星顺数据对接      2020-12-02
 * **********************************************************************
 */
 ...
 */
@Component({
  selector: 'agile-xingshun-home-comm-list-component',
  templateUrl: './home-comm-list.component.html',
  styleUrls: [
    './home-comm-list.component.css'
  ]
})
export class AgileXingshunHomeCommListComponent extends CommonPage implements OnInit {
  @Input() supers: any;
  total = 0;
  rows: any[] = [];
  words = '';
  ...
  public viewProcess(paramMainFlowId: string) {
    this.xn.router.navigate([`agile-xingshun/main-list/detail/${paramMainFlowId}`]);
  }
  ...
  public doProcess(record: any) {
    record.proxyType = record.proxyType === ProxyType.AVENGER ? ProxyType.AVENGER : ProxyType.AGILE_XINGSHUN;
