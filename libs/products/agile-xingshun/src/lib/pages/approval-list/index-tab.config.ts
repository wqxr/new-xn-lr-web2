...
export default class AgileXingshunApprovalListIndexTabConfig {
  // 交易列表 -采购融资，默认配置
    ...
    searches: [
      {
        ...
        checkerId: 'type',
        type: 'linkage-select',
        options: { ref: 'productType_yjl_xingshun' },
        required: false,
        sortOrder: 12,
      },
      {
          ...
          subTabList: [
            {
                ...
                rowButtons: [
                  // TODO
                  {
                    ...
                    click: (
                      ...
                      xn.router.navigate(
                        [
                          `/console/record/avenger/new/sub_factoring_change_yjl_520`,
                        ],
                        {
                          queryParams: {
                            id: 'sub_factoring_change_yjl_520',
                            relate: 'mainFlowId',
              ...
              searches: [
                ...AgileXingshunApprovalListIndexTabConfig.normalbusiness
                  .searches,
              ],
              headText: [
                ...AgileXingshunApprovalListIndexTabConfig.normalbusiness.heads,
                {
                  label: '付款申请表',
                  value: 'receivetable',
                  type: 'contract',
...

            {
              ...
              searches: [
                ...AgileXingshunApprovalListIndexTabConfig.SpecialBusinesslist
                  .searches,
              ],
              headText: [
                ...AgileXingshunApprovalListIndexTabConfig.SpecialBusinesslist
          ...
          subTabList: [
            {
              ...
              searches:
                AgileXingshunApprovalListIndexTabConfig.approvalBusinesslist
                  .searches,
              headText: [
                ...AgileXingshunApprovalListIndexTabConfig.approvalBusinesslist
                  .heads,
          ...
          subTabList: [
            {
              ...
              searches: [
                ...AgileXingshunApprovalListIndexTabConfig.readySigncontract
                  .searches,
              ],
              headText: [
                ...AgileXingshunApprovalListIndexTabConfig.readySigncontract
          ...
          subTabList: [
            {
              ...
              searches: [
                ...AgileXingshunApprovalListIndexTabConfig.searcherCommon
                  .searches,
                {
                  title: '出纳下载次数',
              ...
              headText: [
                ...AgileXingshunApprovalListIndexTabConfig.headscommon.heads,
                {
                  label: '应收账款转让协议',
                  value: 'receiveFiles',
                  type: 'contract',
