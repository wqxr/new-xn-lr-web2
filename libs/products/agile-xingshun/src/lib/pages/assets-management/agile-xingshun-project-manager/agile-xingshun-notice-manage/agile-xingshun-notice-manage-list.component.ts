...
@Component({
    selector: 'agile-xingshun-notice-manage',
    templateUrl: `./agile-xingshun-notice-manage-list.component.html`,
    styles: [
        `
        .item-box {
            position: relative;
...
export class AgileXingshunNoticeManageComponent implements OnInit {
