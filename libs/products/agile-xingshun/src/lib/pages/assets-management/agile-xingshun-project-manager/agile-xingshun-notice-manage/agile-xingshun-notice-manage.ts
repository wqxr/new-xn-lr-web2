 ...
 * @summary：雅居乐-星顺-项目管理-提醒管理-提醒配置列表
 * @version: 1.0
 * **********************************************************************
...
export default class AgileXingshunNoticeManageList {
  static ManageList = {
    heads: [
          ...
          subTabList: [
            {
              ...
              searches: AgileXingshunNoticeManageList.ManageList.searches,
              headText: AgileXingshunNoticeManageList.ManageList.heads,
            },
          ],
