...
// 标准保理 - 交易列表
export default class AgileXingshunEnterPoolConfig {
    // 地产类ABS
    static enterPoolList = {
        ...
        searches: [
            ...
            { title: '交易状态', checkerId: 'tradeStatus', type: 'select', required: false, sortOrder: 5, options: { ref: 'agileXsTradeStatus' }, },
            ...
            { title: '渠道', checkerId: 'productType', type: 'linkage-select', required: false, sortOrder: 8, options: { ref: 'productType_yjl_xingshun' } },
        ] as CheckersOutputModel[]
    };
    static readonly config = {
        enterPoolList: {
            title: '拟入池交易列表-雅居乐-星顺',
            tabList: [
                {
                    ...
                    searches: AgileXingshunEnterPoolConfig.enterPoolList.searches,
                    headText: AgileXingshunEnterPoolConfig.enterPoolList.heads,
