 ...
 * All rights reserved.
 *
 * @file：AgileXingshunOnceContractTemplateTab
 * @summary：雅居乐-星顺 一、二次合同转让管理列表配置
 * @version: 1.0
 * **********************************************************************
...
export default class AgileXingshunOnceContractTemplateTab {
                    ...
                    subTabList: [
                        {
                            ...
                            searches: AgileXingshunOnceContractTemplateTab.contractGroupList.searches,
                            params: 0,
                            headText: [...AgileXingshunOnceContractTemplateTab.contractGroupList.heads],
                        }
                    ],
                    ...
                    subTabList: [
                        {
                            ...
                            searches: AgileXingshunOnceContractTemplateTab.contractTemplateList.searches,
                            params: 1,
                            headText: [...AgileXingshunOnceContractTemplateTab.contractTemplateList.heads],
                        }
                    ],
                    ...
                    subTabList: [
                        {
                            ...
                            searches: AgileXingshunOnceContractTemplateTab.secondContractTemplateList.searches,
                            params: 1,
                            headText: [...AgileXingshunOnceContractTemplateTab.secondContractTemplateList.heads],
                        }
                    ],
