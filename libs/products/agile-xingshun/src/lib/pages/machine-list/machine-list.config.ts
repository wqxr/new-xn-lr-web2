 ...
 * 1.0                 hucongying       雅居乐-星顺台账列表      2020-10-26
 * **********************************************************************
 */
...
export default class MachineIndexTabConfig {
  ...
  static MachineaccountTab = {
    heads: [
      ...
      {
        label: '是否有履约证明', value: 'isPerformance', type: 'text1',
    ...
    searches: [
...

      {
        ...
        options: { ref: 'machineAgileXsTradeStatus' },
        required: false,
        sortOrder: 7
      },
      {
      ...
      {
        title: '是否有履约证明', checkerId: 'isPerformance', type: 'select', options: { ref: 'defaultRadio' },
        required: false, sortOrder: 15, show: true
      },
      {
          ...
          subTabList: [
            {
              ...
              searches: [...MachineIndexTabConfig.MachineaccountTab.searches,
              {
                ...
                options: { ref: 'productType_yjl_xingshun' }, required: false, sortOrder: 12
              },
              {
          ...
          subTabList: [
            {
                ...
                rowButtons: [
                  {
                    ...
                    click: (base: CommBase, params, xn: XnService, hwModeService: HwModeService) => {
                      ...
                      hwModeService.AgileXingshunViewProcess(params.mainFlowId, params.isProxy);
                    }
                  },
                  {
              ...
              { label: '付款确认书文件', value: 'pdfProjectFiles', type: 'file', width: '7%', },
              ],
            },
            {
              label: '已完成',
