import {
    Component, ViewChild, ChangeDetectorRef, ViewContainerRef,
...
export class AgileXingshunSingleSearchListModalComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    public getBtnClass(btn: string): string {
        return btn === 'submit' ? 'btn btn-success' : 'btn btn-default';
    }
