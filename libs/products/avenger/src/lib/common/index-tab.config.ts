  ...
  static avengerLists = {
    ...
    searches: [
      ...
      },
      {
        ...
        type: 'select',
        options: { ref: 'avengerTransactionStatus' },
        required: false,
        sortOrder: 4,
      },
      {
      ...
      tabList: [
        {
          ...
          subTabList: [
                ...
                rowButtons: [
                  ...
                  },
                  {
                    ...
                    click: (
                      ...
                      // 拼接文件
                      xn.router.navigate(
                        [`/console/record/avenger/new/sub_factoring_stop_540`],
                        {
                          queryParams: {
            ...
            },
            {
              ...
              searches: [
                ...IndexTabConfig.avengerLists.searches,
                {
                  title: '还款状态',
                  checkerId: 'payStatus',
                  type: 'select',
              ...
              headText: arraySplice(
                IndexTabConfig.avengerLists.heads,
                { label: '还款状态', value: 'payStatus', type: '还款状态' },
                'factoringEndDate',
                'before'
              ).filter((arr) => arr.value !== 'interest'),
            },
            {
              label: '已还款',
              value: 'DONE',
