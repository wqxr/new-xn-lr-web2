 ...
 * @LastEditTime: 2021-01-06 18:33:59
 * @FilePath: \xn-lr-web2\libs\products\bank-shanghai\src\lib\logic\pre_record.ts
...
export default class PreRecordConfig {
  ...
  static preRecordlist = {
      heads: [
          ...
          { label: '渠道', value: 'type', type: 'productType', width: '6%'  },
      ...
      searches: [
          ...
          { title: '渠道', checkerId: 'type', type: 'select', options: {
