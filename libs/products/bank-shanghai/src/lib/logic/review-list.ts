...
export default class ReviewListConfig {
  static defaultFields: FormlyFieldConfig[] = [
    ...
    },
    {
      ...
      templateOptions: {
        ...
        nzPlaceHolder: '请选择',
        nzAllowClear: true,
        options: SelectOptions.get('tradeStatus_sh'),
        labelSpan: 9,
        controlSpan: 15,
      },
      hooks: {
    ...
    },
    {
      ...
      templateOptions: {
        ...
        nzPlaceHolder: '请选择',
        nzAllowClear: true,
        options: SelectOptions.get('acceptState'),
        labelSpan: 9,
        controlSpan: 15,
      },
    },
    ...
    },
    {
      ...
      templateOptions: {
        ...
        nzDefaultPickerValue: [],
        nzRanges: {
          // 此刻: [new Date(), new Date()],
          // 今日: [startOfDay(new Date()), endOfDay(new Date())],
  ...
  static defaultColumns: Column[] = [
    ...
    { title: '资金中心受理情况', index: 'acceptState', width: 150, render: 'multipleMatchTpl' },
    { title: '可放款批次号', index: 'payBatch', width: 200,  },
    { title: '实际放款批次号', index: 'realyPayBatch', width: 200,  },
    { title: '一线审核时间', index: 'ccsAduitDatetime', width: 200, render: 'dateTimeTpl' },
    { title: '一线审批时间', index: 'ccsApproveTime', width: 200, render: 'dateTimeTpl' },
    { title: '资金中心审核时间', index: 'ccsZauditDate', width: 200, render: 'dateTimeTpl' },
