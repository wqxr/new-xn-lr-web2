...
* All rights reserved.
*
* @file：libs\products\bank-shanghai\src\lib\pages\puhui-company-list\account-detail\account-detail-config.ts
* @summary：普惠开户详情页面配置文件
* @version: 1.0
* *************************************************************************
* revision             author            reason             date
* 1.0                 hucongying           init          2021-07-22
***************************************************************************/
...
export const showFields: CheckersOutputModel[] = [
  ...
  },
  {
    ...
    type: "text",
    title: "经办人姓名",
    options: { readonly: true, showWhen: ["appApplyType", ["2"]] },
    value: ""
  },
  {
  ...
  },
  {
    ...
    options: {
      ...
      picSize: 5120, helpMsg: "请上传大小5M以内的JPEG/JPG/PNG格式文件", showWhen: ["appApplyType", ["2"]]
    },
    value: ""
  },
  {
  ...
  },
  {
    ...
    title: "企业授权书",
    options: {
      readonly: true, fileext: "jpg, jpeg, png, pdf", picSize: 500, showWhen: ["appApplyType", ["2"]]
    },
    value: ""
  },
  {
