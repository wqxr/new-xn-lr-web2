...
* All rights reserved.
*
* @file：libs\products\bank-shanghai\src\lib\pages\puhui-company-list\account-detail\account-detail.component.ts
* @summary：普惠开户账户详情页面
* @version: 1.0
* *************************************************************************
...
export class PuhuiAccountDetailComponent implements OnInit {
  // appId
  public appId: string = '';
  // 审核表单信息配置
  ...
  async buildForm() {
    ...
    try {
      ...
      console.log('bbbbbbbbb', this.checkShows);
