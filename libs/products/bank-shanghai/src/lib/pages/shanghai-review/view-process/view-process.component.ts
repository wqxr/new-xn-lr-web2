 ...
 * @LastEditTime: 2021-05-27 19:01:10
 * @FilePath: \xn-lr-web2\libs\products\bank-shanghai\src\lib\pages\shanghai-review\view-process\view-process.component.ts
...
export class ViewProcessComponent implements OnInit, AfterViewInit {
    ...
    const checkersNew = [
      ...
      },
      {
        ...
        fieldGroup: [
          {
            rowSpan: 24,
            checkerIdGroup: ['eAccountStatus', 'eAcctNo', 'debtUnitUser', 'debtUnitUserMobile', 'debtUnitRegisterAddress', 'debtUnitAddress', 'projectCompanyName', 'projectCompanyCustNo'],
            checkerGroup: checkers.filter((x: any) => ['eAccountStatus', 'eAcctNo', 'debtUnitUser', 'debtUnitUserMobile', 'debtUnitRegisterAddress', 'debtUnitAddress', 'projectCompanyName', 'projectCompanyCustNo']
              .includes(x.checkerId)).map((y: any) => {
                y.checkerSpan = 8;
                return y;
              })
