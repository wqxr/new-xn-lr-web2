 ...
 * 1.0                 yutianbao        变更流程保理审核         2019-02-05
 * **********************************************************************
 */
        ...
        if (svrConfig.procedure.procedureId === 'operate') {
            ...
            try {
                ...
                if (correctFile === '') {
                    ...
                    // let others = JSON.parse(svrConfig.checkers.filter((x: any) => x.checkerId === 'performanceFile')[0].other);
                    // others.show = true;
                    // svrConfig.checkers.filter((x: any) => x.checkerId === 'performanceFile')[0].other = JSON.stringify(others);
                } else {
                    alert = '';
                }
                if (alert !== '') {
