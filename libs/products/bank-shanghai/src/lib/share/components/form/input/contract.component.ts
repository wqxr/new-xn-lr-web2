...
@DynamicForm({ type: 'contract-input', formModule: 'dragon-input' })
export class ShangHaiContractComponent implements OnInit {
    ...
    showContract(id, secret, label) {
        XnModalUtils.openInViewContainer(this.xn, this.vcr, ShangHaiPdfSignModalComponent, {
            id,
            secret,
            label,
            readonly: true
