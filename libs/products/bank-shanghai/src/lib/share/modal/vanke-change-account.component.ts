...
@Component({
    ...
    selector: 'lib-sh-change-account',
    styles: [`
    .modal-title{
        height:50px;
    }
...
export class ShViewChangeAccountComponent implements OnInit {
    ...
    paramType: number;
    title = '';
    constructor(private xn: XnService, public hwModeService: HwModeService, private er: ElementRef, ) {
    }
