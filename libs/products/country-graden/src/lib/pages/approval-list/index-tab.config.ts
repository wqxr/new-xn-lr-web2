...
export default class CountryGradenApprovalListIndexTabConfig {
  // 交易列表 -采购融资，默认配置
    ...
    searches: [
      {
        ...
        checkerId: 'type',
        type: 'linkage-select',
        options: { ref: 'productType_dragon' },
        required: false,
        sortOrder: 12,
      },
      {
          ...
          subTabList: [
            {
              ...
              searches: [
                ...CountryGradenApprovalListIndexTabConfig.normalbusiness
                  .searches,
              ],
              headText: [
                ...CountryGradenApprovalListIndexTabConfig.normalbusiness.heads,
                {
                  label: '付款申请表',
                  value: 'receivetable',
                  type: 'contract',
...

            {
              ...
              searches: [
                ...CountryGradenApprovalListIndexTabConfig.SpecialBusinesslist
                  .searches,
              ],
              headText: [
                ...CountryGradenApprovalListIndexTabConfig.SpecialBusinesslist
          ...
          subTabList: [
            {
              ...
              searches:
                CountryGradenApprovalListIndexTabConfig.approvalBusinesslist
                  .searches,
              headText: [
                ...CountryGradenApprovalListIndexTabConfig.approvalBusinesslist
                  .heads,
          ...
          subTabList: [
            {
              ...
              searches: [
                ...CountryGradenApprovalListIndexTabConfig.readySigncontract
                  .searches,
              ],
              headText: [
                ...CountryGradenApprovalListIndexTabConfig.readySigncontract
          ...
          subTabList: [
            {
              ...
              searches: [
                ...CountryGradenApprovalListIndexTabConfig.searcherCommon
                  .searches,
                {
                  title: '出纳下载次数',
              ...
              headText: [
                ...CountryGradenApprovalListIndexTabConfig.headscommon.heads,
          ...
          subTabList: [
            {
              ...
              edit: {
                leftheadButtons: [
                  ...
                  {
                    label: '放款回单匹配',
                    operate: 'loan_receipt',
                    post_url: '/customer/changecompany',
                    disabled: false,
                  },
                  {
                    label: '对账清单',
                    operate: 'reconciliation_list',
                    post_url: '/customer/changecompany',
                    disabled: false,
                  },
                ],
