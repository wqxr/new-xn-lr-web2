 ...
 * All rights reserved.
 *
 * @file：CountryGradenSecondTransferContractManagerComponent
 * @summary：碧桂园-二次转让合同管理
 * @version: 1.0
 * **********************************************************************
...
export class CountryGradenSecondTransferContractManagerComponent implements OnInit {
    tabConfig: any;
