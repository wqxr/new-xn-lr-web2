...
@Component({
    selector: 'country-graden-project-management-component',
    templateUrl: `./country-graden-project-management.component.html`,
    styles: [`
    .item-box {
        position: relative;
        display: flex;
...
export class CountryGradenProjectmanageComponent implements OnInit {
    tabConfig: any;
    ...
    public handleRowClick(item: any, btn: ButtonConfigModel, i: number) {
        ...
        switch (btn.operate) {
            ...
            case 'notice_manage':  // 提醒管理
                this.xn.router.navigate(['/country-graden/assets-management/notice-manage'], {
                    queryParams: {
                        project_manage_id: item.project_manage_id,
                        projectName: item.projectName
                    }
            ...
            .subscribe((v) => {
                ...
                if (v === null) {
                    ...
                    if (types === 2) {
                        ...
                        v.headquarters = HeadquartersTypeEnum[9];
