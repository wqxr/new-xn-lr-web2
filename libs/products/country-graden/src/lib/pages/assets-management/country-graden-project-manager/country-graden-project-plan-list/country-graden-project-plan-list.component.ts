...
import ProjectManagerplanList from './country-graden-project-plan';

declare const moment: any;
declare const $: any;
@Component({
    selector: 'country-graden-project-plan-list',
    templateUrl: `./country-graden-project-plan-list.component.html`,
    styles: [`
    .item-box {
        position: relative;
        display: flex;
...
export class CountryGradenProjectmanagePlanComponent implements OnInit {
    tabConfig: any;
    ...
    ngOnInit(): void {
        this.router.queryParams.subscribe(x => {
            this.title = '项目管理-碧桂园>' + x.title + '>' + x.projectName + '-' + x.headquarters;
  ...
  */
     ...
     */
    navBack() {
        this.xn.router.navigate(['/country-graden/assets-management/project-list'], {
            queryParams: {
