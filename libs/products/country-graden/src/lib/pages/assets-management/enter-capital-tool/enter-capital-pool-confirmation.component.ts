...
export class CountryGradenEnterpoolComponent implements OnInit {
    tabConfig: any;
    ...
    public isFirst = true;
    public headquarters = HeadquartersTypeEnum[9];
    fitProject = '';
    ...
    downLoadList: any[] = [];
    private defaultHeadquarter = HeadquartersTypeEnum[9];
    ...
    public exportCapital() {
        ...
        XnModalUtils.openInViewContainer(this.xn, this.vcr, CapitalPoolExportListModalComponent, params).subscribe(x => {
            ...
            const param = {
                ...
                capitalPoolId: '',
                scope: x.scope,
                headquarters: HeadquartersTypeEnum[9]
            };
