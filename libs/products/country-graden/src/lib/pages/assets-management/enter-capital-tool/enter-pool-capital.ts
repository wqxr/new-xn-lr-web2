...
// 标准保理 - 交易列表
export default class CountryGradenEnterPoolConfig {
    // 地产类ABS
    static enterPoolList = {
        ...
        searches: [
            ...
            { title: '交易状态', checkerId: 'tradeStatus', type: 'select', required: false, sortOrder: 5, options: { ref: 'countryGradenTradeStatus' }, },
            ...
            tabList: [
                {
                    ...
                    searches: CountryGradenEnterPoolConfig.enterPoolList.searches,
                    headText: CountryGradenEnterPoolConfig.enterPoolList.heads,
