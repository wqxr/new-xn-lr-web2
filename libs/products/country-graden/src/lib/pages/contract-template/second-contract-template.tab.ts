...
export default class CountryGradenOnceContractTemplateTab {
                    ...
                    subTabList: [
                        {
                                ...
                                headButtons: [
                                    {
                                        ...
                                        click: (xn: XnService, params) => {
                                            ...
                                            if (!(rolesArr && rolesArr.length)) {
                                                ...
                                                xn.router.navigate([`/country-graden/record/new/`],
                                                {
                                                    queryParams: {
                            ...
                            searches: CountryGradenOnceContractTemplateTab.contractGroupList.searches,
                            params: 0,
                            headText: [...CountryGradenOnceContractTemplateTab.contractGroupList.heads],
                        }
                    ],
                    ...
                    subTabList: [
                        {
                            ...
                            searches: CountryGradenOnceContractTemplateTab.contractTemplateList.searches,
                            params: 1,
                            headText: [...CountryGradenOnceContractTemplateTab.contractTemplateList.heads],
                        }
                    ],
