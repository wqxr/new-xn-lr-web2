 ...
 * 1.0                 hucongying       碧桂园台账列表      2020-10-26
 * **********************************************************************
 */
...
export default class MachineIndexTabConfig {
  ...
  static MachineaccountTab = {
    heads: [
      ...
      {
        label: '托管行开户名', value: 'bankAccountName', type: 'text', _inList: {
          sort: false,
          search: true
        },
      },
      {
        label: '托管行账号', value: 'bankAccountNo', type: 'text', _inList: {
          sort: false,
          search: true
        },
      },
      {
        label: '托管行开户行', value: 'bankName', type: 'text', _inList: {
          sort: false,
          search: true
        },
      },
      {
        label: '发行期数', value: 'publishPeriods', type: 'text', _inList: {
          sort: false,
          search: true
        },
      },
      ...
      {
        label: '交易状态', value: 'flowId', type: 'countryGradenTradeStatus', _inList: {
          sort: false,
          search: true
        },
      },
      ...
      { label: '碧桂园数据对接情况', value: 'vankeCallState', type: 'vankeCallState', width: '7%', },
    ...
    searches: [
      ...
      {
        title: '交易状态完成时间', checkerId: 'tradeTime', type: 'select-time', required: false, sortOrder: 7, options: { ref: 'countryListGradenTrade' },
      },
      ...
      {
        title: '碧桂园数据对接情况', checkerId: 'vankeCallState', type: 'select',
        options: { ref: 'vankeCallState' }, required: false, sortOrder: 19, base: 'number'
      },
      {
        title: '审核暂停状态', checkerId: 'pauseStatus', type: 'select',
        options: { ref: 'pauseStatus' }, required: false, sortOrder: 23, base: 'number'
      },
      {
          ...
          subTabList: [
            {
              ...
              edit: {
                headButtons: [
                  ...
                  {
                    label: '向碧桂园推送清单',
                    operate: 'pushList-bgy',
                    post_url: '',
                    disabled: false,
                  },
                  {
                    label: '向碧桂园推送托管行信息',
                    operate: 'pushBank-bgy',
                    post_url: '',
                    disabled: false,
                  },
                ],
                ...
                rowButtons: [
                  {
                    ...
                    click: (base: CommBase, params, xn: XnService, hwModeService: HwModeService) => {
                      hwModeService.CountryGradenviewProcess(params.mainFlowId);
                    }
                  },
                  {
                    label: '中止交易', operate: 'stop', post_url: '',
