...
export default class CountryGradenPaymentTabConfig {
    // 交易列表 -采购融资，默认配置
                    ...
                    subTabList: [
                        {
                            ...
                            searches: CountryGradenPaymentTabConfig.dragonapprovalLists.searches,
                            params: 0,
                            headText: [...CountryGradenPaymentTabConfig.dragonapprovalLists.heads,
