 ...
 * All rights reserved.
 *
 * @file：BgyDataChangeList
 * @summary：碧桂园数据对接情况配置列表
 * @version: 1.0
 * **********************************************************************
 * revision             author            reason             date
 * 1.0                hucongying      碧桂园数据对接       2020-11-01
 * **********************************************************************
 */


export default class BgyDataChangeList {
                    ...
                    subTabList: [
                        {
                            ...
                            canChecked: true,
                            count: 0,
                            headText: BgyDataChangeList.interfacePush.heads,
                        },
                    ],
                    ...
                    subTabList: [
                        {
                            ...
                            canSearch: true,
                            canChecked: true,
                            headText: BgyDataChangeList.dataChangeList.heads,
                        },
                    ],
                    post_url: '/sub_system/bgy_system/get_bgy_history',
                    params: 2,
    ...
    static reorganizeData(resData: { list: any[], count: number },
        ...
        allFiledArr.forEach((val, index, arr) => {
            if (resData.list) {
                ...
                const item = {
                    field: BgyDataChangeList.getConfLabel(filedLabelArr, val),
                    currentField: '',
                    fieldName: val,   // 字段标识
                    isChanged: BgyDataChangeList.filedChanged(resData, val, heads),   // 是否有变动，标红
                    fieldType: BgyDataChangeList.jdugeFieldType(val)
                };
                // 业务平台数据
...
export const dateTimeType = ['invalidTimes', 'ccsCreatetime', 'ccsUpdatetime', 'preTime', 'signTime',
    'signDownTime', 'refundTime', 'bankConfirmDate', 'webUpdateTime', 'oprtUpdatetime'
];
export const longdatetimeType = ['ccsAduitDatetime', 'ccsApproveTime', 'ccsZauditDate'];
export const selectType = ['scfStatus', 'preState', 'updateType', 'payState', 'signStatus', 'signIsDown',
    'refundState', 'realyPayState', 'acceptState', 'bankConfirmState', 'isGiveFile'
];
