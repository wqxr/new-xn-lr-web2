...
// 标准保理 - 交易列表
export default class DragonEnterPoolConfig {
    // 地产类ABS
    static enterPoolList = {
        ...
        searches: [
            ...
            { title: '交易状态', checkerId: 'tradeStatus', type: 'select', required: false, sortOrder: 5, options: { ref: 'dragonTradeStatus' }, },
            ...
            { title: '渠道', checkerId: 'productType', type: 'linkage-select', required: false, sortOrder: 8, options: { ref: 'productType_logan' } },
            { title: '总部提单日期', checkerId: 'isHeadPreDate', type: 'dragon-loandate', required: false, sortOrder: 9, },
            { title: '总部公司', checkerId: 'headquarters', type: 'select', required: false, sortOrder: 5, options: { ref: 'newenterprise_dragon2' }, },

            // { title: '预计放款日期', checkerId: 'priorityLoanDate', type: 'dragon-loandate', required: false, sortOrder: 10 },
            // { title: '实际放款日', checkerId: 'realLoanDate', type: 'dragon-loandate', required: false, sortOrder: 11 },
            // { title: '是否补充付款账户', checkerId: 'isFundingInfo', type: 'select', options: { ref: 'isFundingInfo' }, base: 'number', required: false, sortOrder: 12 },
            ...
            tabList: [
                {
                    ...
                    searches: DragonEnterPoolConfig.enterPoolList.searches,
                    headText: DragonEnterPoolConfig.enterPoolList.heads,
