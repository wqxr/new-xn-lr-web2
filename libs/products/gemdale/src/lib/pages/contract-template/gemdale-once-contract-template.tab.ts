...
export default class GemdaleonceContractTemplateTab {
                    ...
                    subTabList: [
                        {
                            ...
                            searches: GemdaleonceContractTemplateTab.contractGroupList.searches,
                            params: 0,
                            headText: [...GemdaleonceContractTemplateTab.contractGroupList.heads],
                        }
                    ],
                    ...
                    subTabList: [
                        {
                            ...
                            searches: GemdaleonceContractTemplateTab.contractTemplateList.searches,
                            params: 1,
                            headText: [...GemdaleonceContractTemplateTab.contractTemplateList.heads],
                        }
                    ],
                    ...
                    subTabList: [
                        {
                            ...
                            searches: GemdaleonceContractTemplateTab.secondContractTemplateList.searches,
                            params: 1,
                            headText: [...GemdaleonceContractTemplateTab.secondContractTemplateList.heads],
                        }
                    ],
                    post_url: '/contract/first_contract_info/contract_template'
                },
