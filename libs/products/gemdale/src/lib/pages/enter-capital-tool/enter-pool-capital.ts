...
// 标准保理 - 交易列表
export default class NewAgileEnterPoolConfig {
    // 地产类ABS
    static enterPoolList = {
        ...
        searches: [
            ...
            { title: '交易状态', checkerId: 'tradeStatus', type: 'select', required: false, sortOrder: 5, options: { ref: 'vankeTradeStatus' }, },
            ...
            { title: '渠道', checkerId: 'productType', type: 'linkage-select', required: false, sortOrder: 8, options: { ref: 'productType_dw' } },
            ...
            tabList: [
                {
                    ...
                    searches: NewAgileEnterPoolConfig.enterPoolList.searches,
                    headText: NewAgileEnterPoolConfig.enterPoolList.heads,
