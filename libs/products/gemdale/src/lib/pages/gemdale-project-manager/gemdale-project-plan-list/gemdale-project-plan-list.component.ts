...
import ProjectManagerplanList from './gemdale-project-plan';

declare const moment: any;

@Component({
    selector: 'gemdale-project-plan-list',
    templateUrl: `./gemdale-project-plan-list.component.html`,
    styles: [`
    .item-box {
        position: relative;
        display: flex;
...
export class GemdaleProjectmanagePlanComponent implements OnInit {
    tabConfig: any;
    ...
    public capitalItemForm(params?: { id: string; name: string }) {
        ...
        XnModalUtils.openInViewContainer(
            ...
            data.headquarters = HeadquartersTypeEnum[2]
            if (!!data) {
                        ...
                        this.xn.api
                            .post(
                                ...
                                Object.assign(
                                    ...
                                    { headquarters: HeadquartersTypeEnum[2], isProxy: 14, capitalPoolName: data.capitalPoolName })
                            )
                            .subscribe(() => {
                                this.onPage({ page: this.paging });
                            });
  ...
  */
     ...
     */
    navBack() {
        this.xn.router.navigate(['/gemdale/assets-management/project-list'], {
            queryParams: {
