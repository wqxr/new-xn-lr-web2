...
@Component({
    selector: 'app-gemdale-transactions-component',
    templateUrl: `./gemdale-transactions-list.component.html`,
    styles: [`
        .title {
            width: 100px;
        }
...
export class GemdaleTransactionsListComponent implements OnInit {
    tabConfig: any;
