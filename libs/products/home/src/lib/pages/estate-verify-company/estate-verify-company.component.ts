...
* All rights reserved.
*
* @file：libs\products\home\src\lib\pages\estate-verify-company\estate-verify-company.component.ts
* @summary：企业资料审核待办列表
* @version: 1.0
* *************************************************************************
...
@Component({
  templateUrl: './estate-verify-company.component.html',
  styles: [
    `.table {
            font-size: 13px;
        }`,
...
export class VerifyCompanyInfoEstateComponent implements OnInit {
  // 待办列表配置
