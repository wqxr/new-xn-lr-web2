...
* All rights reserved.
*
* @file：libs\products\home\src\lib\pages\estate-verify-company\todo-verify-company-info.ts
* @summary：审核企业资料待办列表配置文件
* @version: 1.0
* *************************************************************************
 ...
 *  首页代办
 */
export default class VerifyCompanyInfoTodo {
  static readonly flowId = '';
  static readonly showName = '企业资料审核待办';
