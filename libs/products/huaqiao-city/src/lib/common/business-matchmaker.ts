...
export default class BusinessMatchmakerList {
    ...
    static MarkMatchmaker = {
        ...
        searches: [
            ...
            // },
            { title: '城市公司', checkerId: 'cityCompany', type: 'text', required: false, sortOrder: 2 },
            { title: '市场部对接人', checkerId: 'isMarket', type: 'select-text', options: { ref: 'accountReceipts' }, required: false, sortOrder: 3 },
    ...
    static OperationMatchmaker = {
        ...
        searches: [
            ...
            { title: '运营部对接人', checkerId: 'isOperator', type: 'select-text', options: { ref: 'accountReceipts' }, required: false, sortOrder: 3 },
            { title: '供应商数量', checkerId: 'debtUnitCount', type: 'number-range', required: false, sortOrder: 4 },
        ] as CheckersOutputModel[]
    };
