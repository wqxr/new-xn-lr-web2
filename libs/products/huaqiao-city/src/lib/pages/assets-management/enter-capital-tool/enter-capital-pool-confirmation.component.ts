...
export class HuaQiaoCityEnterpoolComponent implements OnInit {
    tabConfig: any;
    ...
    public isFirst = true;
    public headquarters = HeadquartersTypeEnum[10];
    fitProject = '';
    ...
    downLoadList: any[] = [];
    private defaultHeadquarter = HeadquartersTypeEnum[10];
