...
import ProjectManagerCapitalList from './huaqiao-city-capital-pool';
declare const moment: any;
declare const $: any;

@Component({
    selector: 'huaqiao-city-capital-management',
    templateUrl: `./huaqiao-city-capital-pool.component.html`,
    styleUrls: ['./huaqiao-city-capital-pool.component.css']
})
export class HuaQiaoCityCapitalpoolComponent implements OnInit, AfterViewInit, OnDestroy {
    tabConfig: any;  // 表格配置
    ...
    private defaultHeadquarter = HeadquartersTypeEnum[10];   // 默认总部公司
    ...
    */
    ...
    private buildParams() {
        ...
        if (this.sorting && this.naming) {
            if (this.defaultValue === 'A' || this.defaultValue === 'C' || this.defaultValue === 'B') {
    ...
    navBack() {
        if (this.isMachineenter === true) {
            ...
            this.xn.router.navigate(['/oct/assets-management/projectPlan-management'], {
                queryParams: {
    ...
    */
    ...
    viewProgress(mainFlowId) {
        this.xn.router.navigate([`oct/main-list/detail/${mainFlowId}`]);
    }
     ...
     */
    addTransaction() {
        this.xn.router.navigate([`/oct/assets-management/enter-pool`], {
            queryParams: {
                ...
                if (x.data.isCapitalPoolSample) {
                    ...
                    XnModalUtils.openInViewContainer(this.xn, this.vcr, EditModalComponent, params).subscribe(v => {
                        if (v === null) {
                            ...
                            // 抽样页面
                            this.xn.router.navigate(['/oct/assets-management/capital-sample'], {
                                queryParams: {
    ...
    // 数据分析
    dataAnalyse() {
        this.xn.router.navigate(['/oct/assets-management/capital-data-analyse'], {
            queryParams: {
                totalCount: this.pageConfig.total,
                sumReceive: this.sumReceive,
                ...this.queryParams
