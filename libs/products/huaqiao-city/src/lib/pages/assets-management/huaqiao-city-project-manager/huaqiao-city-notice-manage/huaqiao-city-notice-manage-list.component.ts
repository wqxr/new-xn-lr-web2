 ...
 * 1.0                 congying         提醒配置列表      2020-06-15
 * **********************************************************************
 */
...
@Component({
    selector: 'huaqiao-city-notice-manage',
    templateUrl: `./huaqiao-city-notice-manage-list.component.html`,
    styles: [
        `
        .item-box {
            position: relative;
...
export class HuaQiaoCityNoticeManageComponent implements OnInit {
