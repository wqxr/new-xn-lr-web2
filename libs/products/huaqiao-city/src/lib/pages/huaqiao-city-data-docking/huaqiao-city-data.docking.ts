...
// 标准保理 -万科接口数据列表
export default class HuaQiaoCitydataDockingConfig {
    // 地产类ABS
                    ...
                    subTabList: [
                        {
                            ...
                            searches: [...HuaQiaoCitydataDockingConfig.dataLockinglist.searches,
                            {
                            ...
                            searchNumber: 8,
                            headNumber: 7,
                            headText: [...HuaQiaoCitydataDockingConfig.dataLockinglist.heads],
                        },
                    ],
                    ...
                    subTabList: [
                        {
                            ...
                            searches: [...HuaQiaoCitydataDockingConfig.dataLockinglist.searches,
                            {
                                ...
                                options: { ref: 'huaqiaoCityListTypesingle' }, required: false, sortOrder: 4
                            },
                            {
                                title: '校验结果', checkerId: 'verifyStatus', type: 'select',
