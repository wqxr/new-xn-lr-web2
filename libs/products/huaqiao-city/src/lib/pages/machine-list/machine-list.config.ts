...
import { SelectOptions, EnumShBankTradeStatus } from 'libs/shared/src/lib/config/select-options';
...
export default class MachineIndexTabConfig {
  ...
  static MachineaccountTab = {
    ...
    searches: [
      ...
      {
        title: '交易状态完成时间', checkerId: 'tradeTime', type: 'select-time', required: false, sortOrder: 7, options: { ref: 'huaqiaoCityListTypesingle' }
      },
...

      {
        ...
        type: 'select',
        selectOptions: [...SelectOptions.get('huaqiaoCityListTypesingle'),
        { label: '中止', value: EnumShBankTradeStatus.stop },
        { label: '退单', value: EnumShBankTradeStatus.chargeback },
        ],
        required: false,
        sortOrder: 6
      },
