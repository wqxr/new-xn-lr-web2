...
export class HuaQiaoCityCapitalPoolCommListComponent extends CommonPage implements OnInit {
    total = 0;
    pageSize = 10;
    first = 0;
    rows: any[] = [];
    ...
    public handleAdd(val: any) {
        this.xn.router.navigate(['/oct/unhandled-list'], {
            queryParams: {
                capitalId: val.id,
