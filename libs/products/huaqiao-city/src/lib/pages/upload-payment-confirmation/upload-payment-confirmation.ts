...
export default class VankepaymentTabConfig {
    // 交易列表 -采购融资，默认配置
                    ...
                    subTabList: [
                        {
                                ...
                                headButtons: [
                                    {
                                        ...
                                        click: (xn: XnService, params) => {
                                            ...
                                            if (!(rolesArr && rolesArr.length)) {
                                                ...
                                                xn.router.navigate([`/oct/record/new/`],
                                                    {
                                                        queryParams: {
                            ...
                            searches: VankepaymentTabConfig.dragonapprovalLists.searches,
                            params: 0,
                            headText: [...VankepaymentTabConfig.dragonapprovalLists.heads,
