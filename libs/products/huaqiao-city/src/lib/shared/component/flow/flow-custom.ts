...
import { OctFinancingPre } from './oct_financing_pre';
import { OctFinancing } from './oct_financing';
import { OctPlatformVerify } from './oct_platform_verify';
import { OctFactoringRisk } from './oct_factoring_risk';
import { OctFinancingSign } from './oct_financing_sign';
import { OctFactoringPassback } from './oct_factoring_passback';
...
export class FlowCustom {
    ...
    static build(
        ...
        switch (name) {
            case 'oct_financing_pre':
                return new OctFinancingPre(xn, loading);
            case 'oct_financing':
                return new OctFinancing(xn, loading);
            case 'oct_platform_verify':
                return new OctPlatformVerify(xn, loading);
            case 'oct_factoring_risk':
                return new OctFactoringRisk(xn, loading);
            case 'oct_financing_sign':
                return new OctFinancingSign(xn, loading, localservice);
            case 'oct_factoring_passback':
                return new OctFactoringPassback(xn, loading);
