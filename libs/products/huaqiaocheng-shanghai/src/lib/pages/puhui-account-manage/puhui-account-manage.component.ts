...
* All rights reserved.
*
* @file：libs\products\huaqiaocheng-shanghai\src\lib\pages\puhui-account-manage\puhui-account-manage.component.ts
* @summary：普惠通账户管理
* @version: 1.0
* *************************************************************************
...
import { SoBankAccountEditModalComponent } from "libs/products/huaqiaocheng-shanghai/src/lib/share/modal/puhui/edit-account-bank-modal.component";
...
@Component({
  selector: 'oct-puhui-account-manage',
...
export class OctPuhuiAccountManageComponent implements OnInit {
  /** 企业 appId */
  ...
  editAccountNo() {
    ...
    if (this.eAccountStatus === AccountStatusEnum.NEED_ACTIVE) {
      ...
      XnModalUtils.openInViewContainer(this.xn, this.vcr, ShEditModalComponent, params).subscribe(v => {
        if (v) {
          this.xn.loading.open();
          this.xn.dragon.post('/shanghai_bank/so_bank_gateway/shPHModifyBindCard',
      ...
      XnModalUtils.openInViewContainer(this.xn, this.vcr,
        SoBankAccountEditModalComponent,
