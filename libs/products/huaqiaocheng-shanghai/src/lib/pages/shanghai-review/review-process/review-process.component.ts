 ...
 * @LastEditTime: 2021-09-27 18:13:42
 * @FilePath: \xn-lr-web2\libs\products\huaqiaocheng-shanghai\src\lib\pages\shanghai-review\review-process\review-process.component.ts
...
@Component({
  selector: 'oct-review-process',
  templateUrl: './review-process.component.html',
  styleUrls: ['./review-process.component.css'],
})
export class OctReviewProcessComponent implements OnInit, AfterViewInit {
