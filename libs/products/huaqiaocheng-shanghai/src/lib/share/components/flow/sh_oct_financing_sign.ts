...
export class ShangHaiOctFinancingSign implements IFlowCustom {
    ...
    afterSubmitandGettip(svrConfig: any): Observable<any> {
        if (svrConfig.procedure.procedureId === 'operate') {
            ...
            this.xn.msgBox.open(false, [
                '签署合同成功！',
                `该笔交易进度可在左侧导航栏【我的产品】-【普惠通-华侨城-上海银行】-【台账】查看，交易id为${svrConfig.record.mainFlowId}`],
            () => {});
        }
        return of(null);
    }
