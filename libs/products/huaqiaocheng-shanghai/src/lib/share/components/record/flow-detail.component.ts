...
export class OctFlowDetailComponent implements OnInit {
    mainFlowId: string;
    params: any;
    ...
    ngOnInit() {
        this.route.params.subscribe((params: Params) => {
            ...
            this.xn.dragon.post('/list/main/detail', { mainFlowId: this.mainFlowId }).subscribe(json => {
