...
* All rights reserved.
*
* @file：libs\products\huaqiaocheng-shanghai\src\lib\share\components\record\puhui\new-puhui.component.ts
* @summary：发起普惠开户流程
* @version: 1.0
* *************************************************************************
...
export class OctPuhuiNewComponent implements OnInit, AfterViewInit {
