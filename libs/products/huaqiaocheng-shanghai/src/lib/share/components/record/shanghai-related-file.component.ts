...
@Component({
  selector: 'oct-sh-file-related',
  templateUrl: './shanghai-related-file.component.html',
  styles: [
    `
      .table {
        font-size: 13px;
...
export class OctShangHaiRelatedFileComponent implements OnInit {
  /** 列表数据 */
  data: any[] = [];
  heads: any[];
