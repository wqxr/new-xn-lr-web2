...
export class OctViewComponent implements OnInit {
    ...
    newSvrConfig: any;
    public mainFlowId = '';
    isshowProgress = false; // 是否显示导航进度条

    constructor(private xn: XnService, private route: ActivatedRoute, private loading: LoadingService,
    ...
    ngOnInit() {
        this.route.params.subscribe((params: Params) => {
            ...
            this.xn.api.dragon.post('/record/record/view', {
                ...
                this.buildRows();
                this.isshowProgress = !!this.svrConfig?.flow?.flowId && !this.svrConfig.flow.flowId.startsWith('sub');
            });
        });
    ...
    public download() {
        ...
        //     this.xn.api.dragon.download('/file/downFile', { files, mainFlowId: this.mainFlowId }
        //     ).subscribe((v: any) => {
        //         this.loading.close();
