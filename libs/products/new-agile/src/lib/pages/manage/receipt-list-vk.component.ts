...
/**
 * base: src\app\pages\console\manage\receipt-list-vk.component.ts
 */
@Component({
...
export class ReceiptListVkComponent extends CommonPage implements OnInit {
    ...
    public fileView(item) {
        XnModalUtils.openInViewContainer(this.xn, this.vcr, MfilesViewModalComponent, JsonTransForm(item)).subscribe(() => {
        });
    }
}
