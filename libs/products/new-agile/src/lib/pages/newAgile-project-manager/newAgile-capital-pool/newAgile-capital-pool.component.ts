...
import ProjectManagerCapitalList from './newAgile-capital-pool';
declare const moment: any;
declare const $: any;

@Component({
    selector: 'newAgile-capital-management',
    templateUrl: `./newAgile-capital-pool.component.html`,
    styleUrls: ['./newAgile-capital-pool.component.css']
})
export class NewAgileCapitalpoolComponent implements OnInit, AfterViewInit, OnDestroy {
    tabConfig: any;  // 表格配置
    ...
    private defaultHeadquarter = HeadquartersTypeEnum[3];   // 默认总部公司
    ...
    */
    public downloadSelectedAttach() {
        ...
        const params = { hasSelect, selectedCompany: HeadquartersTypeEnum[3], fileList: [], capitalType: CapitalType.New };
    ...
    */
    ...
    navBack() {
        if (this.isMachineenter === true) {
            ...
            this.xn.router.navigate(['/new-agile/assets-management/projectPlan-management'], {
                queryParams: {
    ...
    */
     ...
     */
    addTransaction() {
        this.xn.router.navigate([`/new-agile/assets-management/enter-pool`], {
            queryParams: {
                ...
                if (x.data.isCapitalPoolSample) {
                    ...
                    XnModalUtils.openInViewContainer(this.xn, this.vcr, EditModalComponent, params).subscribe(v => {
                        if (v === null) {
                            ...
                            // 抽样页面
                            this.xn.router.navigate(['/new-agile/assets-management/capital-sample'], {
                                queryParams: {
    ...
    // 数据分析
    dataAnalyse() {
        this.xn.router.navigate(['/new-agile/assets-management/capital-data-analyse'], {
            queryParams: {
                totalCount: this.pageConfig.total,
                sumReceive: this.sumReceive,
                ...this.queryParams
