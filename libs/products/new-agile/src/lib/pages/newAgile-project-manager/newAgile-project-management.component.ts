...
@Component({
    selector: 'newAgile-project-management-component',
    templateUrl: `./newAgile-project-management.component.html`,
    styles: [`
    .item-box {
        position: relative;
        display: flex;
...
export class NewAgileProjectmanageComponent implements OnInit {
    tabConfig: any;
    ...
    public isPlatForm: boolean = this.xn.user.orgType === 99;
    ...
    public handleRowClick(item: any, btn: ButtonConfigModel, i: number) {
        ...
        switch (btn.operate) {
            ...
            case 'notice_manage':  // 提醒管理
                this.xn.router.navigate(['/new-agile/assets-management/notice-manage'], {
                    queryParams: {
                        project_manage_id: item.project_manage_id,
                        projectName: item.projectName
                    }
            ...
            .subscribe((v) => {
                ...
                if (v === null) {
                    ...
                    if (types === 2) {
                        ...
                        v.headquarters = HeadquartersTypeEnum[4];
