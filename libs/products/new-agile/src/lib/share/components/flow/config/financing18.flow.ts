 ...
 *  保理商审核 雅居乐-星顺模式
 */
export class Financing18Flow implements IFlowCustom {
    ...
    preSubmit(svrConfig: any, formValue: any): Observable<any> {
        ...
        if (svrConfig.actions[0].checkers[0].data === HeadquartersTypeEnum[4] && this.xn.user.orgType === 1) {
            return of(null);
        }
