...
import { FlowCustom } from '../flow/config/flow.custom';
...
// import {configData} from 'libs/shared/src/lib/config/svrConfig'; // 引入测试数据

@Component({
    selector: 'xn-new-agile-view',
...
export class ViewComponent implements OnInit {
        ...
        this.route.params.subscribe((params: Params) => {
            ...
            this.xn.api.post('/record/record?method=view', {
                ...
                .subscribe(json => {
                    ...
                    this.flowProcess = FlowCustom.calcFlowProcess(this.svrConfig.flow.flowId);
    ...
    get currentStep() {
       const { record } = this.svrConfig;
       const step = FlowCustom.getCurrentFlowProcessStep(record.status);
       return step ? step.id : '';
    }
