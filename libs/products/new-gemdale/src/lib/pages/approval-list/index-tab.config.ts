...
export default class NewGemdaleApprovalListIndexTabConfig {
  // 交易列表 -采购融资，默认配置
          ...
          subTabList: [
            {
              ...
              searches: [...NewGemdaleApprovalListIndexTabConfig.normalbusiness.searches,

              ],
              headText: [...NewGemdaleApprovalListIndexTabConfig.normalbusiness.heads,
              ],
            },
            {
              label: '特殊业务',
              ...
              searches: [...NewGemdaleApprovalListIndexTabConfig.SpecialBusinesslist.searches,
              ],
              headText: [...NewGemdaleApprovalListIndexTabConfig.SpecialBusinesslist.heads,
              { label: '付款申请表', value: 'receivetable', type: 'contract' },
              ],
            },
          ],
          ...
          subTabList: [
            {
              ...
              searches: NewGemdaleApprovalListIndexTabConfig.approvalBusinesslist.searches,
              headText: [...NewGemdaleApprovalListIndexTabConfig.approvalBusinesslist.heads,
          ...
          subTabList: [
            {
              ...
              searches: [...NewGemdaleApprovalListIndexTabConfig.readySigncontract.searches,

              ],
              headText: [...NewGemdaleApprovalListIndexTabConfig.readySigncontract.heads,
              { label: '起息日', value: 'valueDate', type: 'date' },
              { label: '转让价款', value: 'changePrice', type: 'receivable' },
          ...
          subTabList: [
            {
              ...
              searches: [...NewGemdaleApprovalListIndexTabConfig.searcherCommon.searches,
              {
              ...
              headText: [...NewGemdaleApprovalListIndexTabConfig.headscommon.heads,
              { label: '当前财务有权审批状态', value: 'financeStatus', type: 'approvalstatus' },
              { label: '应收账款转让协议', value: 'receiveFiles', type: 'contract' },
              { label: '起息日', value: 'valueDate', type: 'date' },
