...
export default class ProjectManagerCapitalList {
    ...
    static basicCapitalList = {
        ...
        searches: <CheckersOutputModel[]>[
            ...
            { title: '交易状态', checkerId: 'flowId', type: 'select', options: { ref: 'newGemdaleTradeStatus' }, required: false, sortOrder: 7, show: true },
    ...
    static transactionFileList = {
        heads: <ListHeadsFieldOutputModel[]>[
            ...
            { label: '付款确认书', value: 'factoringPayConfirmYyj', type: 'contract', show: true },
