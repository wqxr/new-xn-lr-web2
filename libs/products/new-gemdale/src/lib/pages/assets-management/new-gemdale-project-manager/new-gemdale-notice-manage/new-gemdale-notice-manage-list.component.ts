...
@Component({
    selector: 'new-gemdale-notice-manage',
    templateUrl: `./new-gemdale-notice-manage-list.component.html`,
    styles: [
        `
        .item-box {
            position: relative;
...
export class NewGemdaleNoticeManageComponent implements OnInit {
