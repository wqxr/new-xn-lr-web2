...
export default class NewGemdaleOnceContractTemplateTab {
                    ...
                    subTabList: [
                        {
                                ...
                                headButtons: [
                                    {
                                        ...
                                        click: (xn: XnService, params) => {
                                            ...
                                            if (!(rolesArr && rolesArr.length)) {
                                                ...
                                                xn.router.navigate([`/new-gemdale/record/new/`],
                                                {
                                                    queryParams: {
                            ...
                            searches: NewGemdaleOnceContractTemplateTab.contractGroupList.searches,
                            params: 0,
                            headText: [...NewGemdaleOnceContractTemplateTab.contractGroupList.heads],
                        }
                    ],
                    ...
                    subTabList: [
                        {
                            ...
                            searches: NewGemdaleOnceContractTemplateTab.contractTemplateList.searches,
                            params: 1,
                            headText: [...NewGemdaleOnceContractTemplateTab.contractTemplateList.heads],
                        }
                    ],
