  ...
  static MachineaccountTab = {
    ...
    searches: [
...

      {
        ...
        options: { ref: 'machineNewGemdaleTradeStatus' },
        required: false,
        sortOrder: 6
      },
      {
      ...
      },
      {
        ...
        options: { ref: 'vankeCallState', showWhen: ['wkType', '1'] }, required: false, sortOrder: 18, base: 'number'
      },
      {
        title: '审核暂停状态', checkerId: 'pauseStatus', type: 'select',
        options: { ref: 'pauseStatus', showWhen: ['wkType', '1'] }, required: false, sortOrder: 19, base: 'number'
      },
      {
