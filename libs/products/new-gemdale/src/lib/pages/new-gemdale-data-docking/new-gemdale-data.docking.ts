...
// 标准保理 -金地接口数据列表
export default class NewGemdaleDataDockingConfig {
  // 地产类ABS
          ...
          subTabList: [
            {
              ...
              searches: [...NewGemdaleDataDockingConfig.dataLockinglist.searches],
              params: 0,
              searchNumber: 14,
              headNumber: 13,
              headText: [...NewGemdaleDataDockingConfig.dataLockinglist.heads],
            },
          ],
          ...
          subTabList: [
            {
              ...
              searches: [
                ...NewGemdaleDataDockingConfig.dataLockinglist.searches,
              ...
              headText: [
                ...
                ...NewGemdaleDataDockingConfig.dataLockinglist.heads],
            },
          ],
          post_url: '/sub_system/jd_system/jd_financing_list'
        },
