...
import RepaymentConfigList from './new-gemdale-repayment';
...
@Component({
  templateUrl: `./new-gemdale-repayment.component.html`,
  styles: [
    `
      [nz-button] {
        margin-right: 8px;
...
export class NewGemdaleRepaymentComponent implements OnInit {
