 ...
 */
@Component({
    templateUrl: './new-gemdale-linkage-select-input.component.html',
    styles: [
        `.xn-dselect-first {
            padding-right: 2px;
        }
...
@DynamicForm({ type: 'linkage-select-jd', formModule: 'dragon-input' })
export class NewGemdaleLinkageSelectInputComponent implements OnInit {
    @Input() row: any;
