...
@Component({
    selector: 'xn-new-gemdale-flow-detail-record-component',
 ...
 */
    ...
    public checkSubprocess(paramRow: any) {
        this.xn.router.navigate([`/new-gemdale/record/view/${paramRow.recordId}`],{queryParams:{mainFlowId:this.mainFlowId}});
