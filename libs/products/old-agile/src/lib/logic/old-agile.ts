...
export default class OldAgile {
    ...
    static readonly webUrlBase = `/console/record/record-vanke/${OldAgile.flowId}}`;
        ...
        headButtons: [
            ...
            // }, 
            {
                ...
                click: (xn: XnService, base: CommBase) => {
                    xn.router.navigate([`/console/record/new/${OldAgile.flowId}`]);
                }
            }
        ],
        ...
        rowButtons: [
            {
                ...
                click: (base: CommBase, record, xn, vcr) => {
                    if ((record.status !== 1 && record.status !== 0) || xn.user.roles.indexOf(record.nowRoleId) < 0) {
                        xn.router.navigate([`/console/record/${OldAgile.flowId}/view/${record.recordId}`]);
                    } else {
                        xn.router.navigate([`/console/record/${OldAgile.flowId}/edit/${record.recordId}`]);
                    }
                }
            },
            // {
