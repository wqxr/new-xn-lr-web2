...
// 标准保理 - 交易列表
export default class OldAgileTransactionTabConfig {
    // 地产类ABS
            ...
            tabList: [
                {
                    ...
                    searches: OldAgileTransactionTabConfig.DragonProjectInfo.searches,
                    headText: OldAgileTransactionTabConfig.DragonProjectInfo.heads,
