 ...
 * 1.0                 congying       雅居乐-拟入池交易列表   2020-08-19
 * **********************************************************************
 */
...
export class OldAgileEnterpoolComponent implements OnInit {
    tabConfig: any;
    ...
    public isFirst = true;
    public headquarters = HeadquartersTypeEnum[3];
    fitProject = '';
    ...
    downLoadList: any[] = [];
    private defaultHeadquarter = HeadquartersTypeEnum[3];
