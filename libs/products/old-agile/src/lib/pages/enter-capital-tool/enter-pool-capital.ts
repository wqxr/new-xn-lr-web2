...
// 标准保理 - 交易列表
export default class OldAgileEnterPoolConfig {
    // 地产类ABS
            ...
            tabList: [
                {
                    ...
                    searches: OldAgileEnterPoolConfig.enterPoolList.searches,
                    headText: OldAgileEnterPoolConfig.enterPoolList.heads,
