...
@Component({
    selector: 'oldAgile-project-management-component',
    templateUrl: `./oldAgile-project-management.component.html`,
    styles: [`
    .item-box {
        position: relative;
        display: flex;
...
export class OldAgileProjectmanageComponent implements OnInit {
    tabConfig: any;
    ...
    public handleRowClick(item: any, btn: ButtonConfigModel, i: number) {
        ...
        switch (btn.operate) {
            ...
            case 'notice_manage':  // 提醒管理
                this.xn.router.navigate(['/old-agile/assets-management/notice-manage'], {
                    queryParams: {
                        project_manage_id: item.project_manage_id,
                        projectName: item.projectName
                    }
  ...
  */
    ...
    private buildParams() {
        ...
        params['headquarters'] = HeadquartersTypeEnum[3]
        return params;
    }
            ...
            .subscribe((v) => {
                ...
                if (v === null) {
                    ...
                    if (types === 2) {
                        ...
                        v.headquarters = HeadquartersTypeEnum[3];
