...
import ProjectManagerplanList from './oldAgile-project-plan';

declare const moment: any;

@Component({
    selector: 'oldAgile-project-plan-list',
    templateUrl: `./oldAgile-project-plan-list.component.html`,
    styles: [`
    .item-box {
        position: relative;
        display: flex;
...
export class OldAgileProjectmanagePlanComponent implements OnInit {
    tabConfig: any;
    ...
    ngOnInit(): void {
        this.router.queryParams.subscribe(x => {
            this.title = '项目管理-雅居乐>' + x.title + '>' + x.projectName + '-' + x.headquarters;
    ...
    getPlan(paramInfo: any) {
        ...
        if (paramInfo.poolFlag === 1) {
            this.xn.router.navigate(['/old-agile/assets-management/capital-pool'], {
                queryParams: {
                    title: this.title,
            ...
            // this.xn.dragon.post('/project_manage/old_pool/pool_info', { capitalPoolId: paramInfo.capitalPoolId }).subscribe(x => {
                // if (x.ret === 0) {
                    this.xn.router.navigate(['/old-agile/trading-list'], {
                        queryParams: {
    ...
    public capitalItemForm(params?: { id: string; name: string }) {
        ...
        XnModalUtils.openInViewContainer(
            ...
            data.headquarters = HeadquartersTypeEnum[3]
            data.headquarters = HeadquartersTypeEnum[3]
            if (!!data) {
                            ...
                            this.xn.api
                                .post(
                                    ...
                                    Object.assign(
                                        ...
                                        { headquarters: HeadquartersTypeEnum[3], isProxy: 6, capitalPoolName: data.capitalPoolName })
                                )
                                .subscribe(() => {
                                    this.onPage({ page: this.paging });
                                });
    ...
    */
    ...
    addTransaction(item: any, btn: ButtonConfigModel) {
        ...
        if (item.poolFlag === 1) {
            ...
            this.xn.router.navigate(['/old-agile/unhandled-list'], {
                queryParams: {
  ...
  */
     ...
     */
    navBack() {
        this.xn.router.navigate(['/old-agile/assets-management/project-list'], {
            queryParams: {
