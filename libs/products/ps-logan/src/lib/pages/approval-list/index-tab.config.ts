        ...
        searches: [
            {
                ...
                options: { ref: 'productType_pslogan' }, required: false, sortOrder: 12
            },
                    ...
                    subTabList: [
                        {
                            ...
                            searches: [...DragonApprovallistIndexTabConfig.normalbusiness.searches,

                            ],
                            headText: [...DragonApprovallistIndexTabConfig.normalbusiness.heads,
                            { label: '付款申请表', value: 'receivetable', type: 'contract' },
                            ],
                        },

                        {
                            ...
                            searches: [...DragonApprovallistIndexTabConfig.SpecialBusinesslist.searches,
                            ],
                            headText: [...DragonApprovallistIndexTabConfig.SpecialBusinesslist.heads,
                            { label: '付款申请表', value: 'receivetable', type: 'contract' },
                            ],
                        },
                    ],
                    ...
                    subTabList: [
                        {
                            ...
                            searches: DragonApprovallistIndexTabConfig.approvalBusinesslist.searches,
                            headText: [...DragonApprovallistIndexTabConfig.approvalBusinesslist.heads,
                    ...
                    subTabList: [
                        {
                            ...
                            searches: [...DragonApprovallistIndexTabConfig.readySigncontract.searches,

                            ],
                            headText: [...DragonApprovallistIndexTabConfig.readySigncontract.heads,
                                { label: '起息日', value: 'valueDate', type: 'date' },
                                { label: '转让价款', value: 'changePrice', type: 'receivable' },
