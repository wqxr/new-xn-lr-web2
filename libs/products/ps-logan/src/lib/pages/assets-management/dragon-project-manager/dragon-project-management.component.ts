...
@Component({
    selector: 'dragon-project-management-component',
    templateUrl: `./dragon-project-management.component.html`,
    styles: [`
    .item-box {
        position: relative;
        display: flex;
...
export class DragonProjectmanageComponent implements OnInit {
    tabConfig: any;
    ...
    public handleRowClick(item: any, btn: ButtonConfigModel, i: number) {
        switch (btn.operate) {
            ...
            case 'notice_manage':  // 提醒管理
                this.xn.router.navigate(['/pslogan/assets-management/notice-manage'], {
                    queryParams: {
                        project_manage_id: item.project_manage_id,
                        projectName: item.projectName
                    }
  ...
  */
    ...
    setUpProject(types: number, paramsInfo?: any) {
        ...
        },
        {
            ...
            value: types === 2 ? paramsInfo.headquarters : ''
        },
        {
            title: '项目类型',
            ...
            .subscribe((v) => {
                ...
                if (v === null) {
                    ...
                    if (types === 2) {
                        ...
                        this.xn.dragon.post('/project_manage/project/project_add ', { ...v, isLgBoShi: 1 }).subscribe(x => {
                            if (x.ret === 0) {
                                this.onPage({ page: this.paging });
                            }
                        });
