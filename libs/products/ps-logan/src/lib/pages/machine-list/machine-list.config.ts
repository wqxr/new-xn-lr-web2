...
export default class MachineIndexTabConfig {
  ...
  static MachineaccountTab = {
    heads: [
      ...
      { label: '供应商是否签署基础交易文件', value: 'lgBasicFlieStatus', type: 'lgBasicFlieStatus' },
    ...
    searches: [
      ...
      {
        title: '交易状态完成时间', checkerId: 'tradeTime', type: 'select-time', required: false, sortOrder: 7, options: { ref: 'dragonListTypesingle' }
      },
      ...
      { title: '供应商是否签署基础交易文件', checkerId: 'lgBasicFlieStatus', type: 'select', options: { ref: 'lgBasicFlieStatus' } },
      {
          ...
          subTabList: [
            {
              ...
              {   // codeFactoringPayConfirm   factoringPayConfirm contract
                label: '付款确认书编号(总部致管理人)', value: 'payConfirmId', type: 'text', _inList: {
                  sort: false,
                  search: true
                },
              },
              { label: '付款确认书文件(总部致管理人)', value: 'pdfProjectFiles', type: 'file', },
          ...
          subTabList: [
            {
              ...
              { label: '付款确认书文件(总部致管理人)', value: 'pdfProjectFiles', type: 'file', width: '7%', },
              ],
            },
            {
              label: '已完成',
