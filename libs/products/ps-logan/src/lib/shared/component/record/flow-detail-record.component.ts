...
@Component({
    selector: 'xn-pslogan-flow-detail-record-component',
...
export class PsLoganFlowDetailRecordComponent implements OnInit {
 ...
 */
    ...
    public checkSubprocess(paramRow: any) {
        this.xn.router.navigate([`/pslogan/record/view/${paramRow.recordId}`]);
