...
export default class VankeEnterPoolConfig {
    ...
    static enterPoolList = {
        heads: [
            ...
            { label: '风险审核冻结状态', value: 'riskFreezeStatus', type: 'selects',options:'freezingStatus' },
        ...
        searches: [
            ...
            { title: '风险审核冻结状态', checkerId: 'riskFreezeStatus', type: 'select', required: false, sortOrder: 10,options: { ref: 'freezingStatus' } },
                        ...
                        rightheadButtons: [
                            {
                                label: '冻结/解冻风险审核',
                                operate: 'frozen_risk',
                                post_url: '/project_manage/pool/change_risk_freeze',
                                disabled: false,
                                click: (xn: XnService, params) => { },
                            },
                            {
