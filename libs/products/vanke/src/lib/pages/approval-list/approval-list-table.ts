...
import { AuditorTypeEnum } from 'libs/shared/src/lib/config/enum/common-enum';
...
export default class ApprovallistIndexTabConfig {
  ...
  static normalbusiness = {
    heads: [
      ...
      {
        label: '付确信息比对结果',
        value: 'payCompareStatus',
        type: 'resultcompare',
      },
      { label: '是否变更账号', value: 'ischangeAccount', type: 'optionsIS' },
      {
        label: '资产池名称',
        value: 'capitalPoolName',
        type: 'capitalPoolName',
      },
      ...
      {
        label: '申请付款单位是否签署合同',
        value: 'isSupplierSign',
        type: 'optionsIS1',
      },
      {
        label: '收款单位是否签署合同',
        value: 'isUpstreamSign',
        type: 'optionsIS2',
      },
      {
        label: '资金渠道',
  ...
  static SpecialBusinesslist = {
    ...
    searches: [
      ...
      {
        title: '当前信贷人有权人审批状态',
        checkerId: 'creditStatus',
        type: 'select',
        options: { ref: 'approvalstatus' },
        required: false,
        sortOrder: 9,
      },
      {
          ...
          subTabList: [
            {
                ...
                rowButtons: [
                  // TODO
                  {
                    ...
                    click: (
                      ...
                      xn.router.navigate(
                        [
                          `/console/record/avenger/new/sub_factoring_change_520`,
                        ],
                        {
                          queryParams: {
              ...
              searches: [
                ...ApprovallistIndexTabConfig.normalbusiness.searches,
                {
                  title: '电子签章状态',
                  ...
                  required: false,
                  sortOrder: 15,
                  options: { ref: 'vankeDockSignStatus' },
                },
              ],
              headText: [
                ...ApprovallistIndexTabConfig.normalbusiness.heads,
                {
                  label: '电子签章状态',
                  value: 'signStatus',
                  type: 'signStatus',
            ...
            },
            {
              ...
              searches: [
                ...ApprovallistIndexTabConfig.SpecialBusinesslist.searches,
                {
                  title: '电子签章状态',
                  checkerId: 'signStatus',
                  type: 'select',
              ...
              headText: [
                ...ApprovallistIndexTabConfig.SpecialBusinesslist.heads,
                {
                  label: '付款申请表',
                  value: 'receivetable',
                  type: 'contract',
            ...
            },
            {
              ...
              edit: {
                headButtons: [
                  // {
                  //   label: '上传中登撤销证明',
                  //   operate: 'upload_zhongdeng_revocation_certificate',
                  //   post_url: '/jd_blh/approval',
                  //   disabled: false,
                  // },
                  {
          ...
          subTabList: [
            {
                ...
                headButtons: [
                  {
                    ...
                    disabled: false,
                    jurisdiction: [AuditorTypeEnum.ADMIN], //按钮的权限
                  },
                  {
                    label: '审批拒绝',
                    ...
                    post_url: '/jd_blh/passApproval',
                    disabled: false,
                    jurisdiction: [AuditorTypeEnum.ADMIN]
                  },
                  {
                    label: '导出清单',
                    operate: 'download_approval_list',
              ...
              searches: [
                ...ApprovallistIndexTabConfig.approvalBusinesslist.searches,
                {
                  title: '标识',
              ...
              headText: [
                ...ApprovallistIndexTabConfig.approvalBusinesslist.heads,
                { label: '转让价款', value: 'changePrice', type: 'receivable' },
                ...
                { label: '标识', value: 'isPreTrade', type: 'isPreTrade' },
              ],
            },
          ],
          post_url: '/aprloan/approval/list',
          ...
          subTabList: [
            {
              ...
              searches: [
                ...ApprovallistIndexTabConfig.readySigncontract.searches,
                {
                  title: '付款确认书校验结果',
                  checkerId: 'pdfProjectResult',
                  type: 'select',
                  options: { ref: 'pdfProjectResult' },
                  required: false,
                  sortOrder: 4,
                },
                {
              ...
              headText: [
                ...ApprovallistIndexTabConfig.readySigncontract.heads,
                { label: '起息日', value: 'valueDate', type: 'date' },
                { label: '转让价款', value: 'changePrice', type: 'receivable' },
                {
                  label: '电子付确下载状态',
          ...
          subTabList: [
            {
              ...
              searches: [
                ...ApprovallistIndexTabConfig.searcherCommon.searches,
                {
                  title: '出纳下载次数',
                  checkerId: 'cnDownTimes',
                  type: 'select',
                  options: { ref: 'accountReceipts' },
                  required: false,
                  sortOrder: 9,
              ...
              headText: [
                ...ApprovallistIndexTabConfig.headscommon.heads,
                {
                  label: '当前财务有权审批状态',
                  value: 'financeStatus',
                  type: 'approvalstatus',
          ...
          subTabList: [
            {
                ...
                rowButtons: [
                  {
                    ...
                    click: (
                      ...
                      xn.router.navigate(
                        [
                          `/console/record/avenger/new/sub_approval_payback_530`,
                        ],
                        {
                          queryParams: {
              ...
              searches: [
                ...
                {
                  title: '退款状态',
                  checkerId: 'backStatus',
                  type: 'select',
                  options: { ref: 'moneyback' },
                  required: false,
                  sortOrder: 12,
                },
                {
