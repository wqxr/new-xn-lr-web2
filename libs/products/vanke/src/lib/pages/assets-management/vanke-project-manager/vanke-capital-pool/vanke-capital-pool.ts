...
export default class ProjectManagerCapitalList {
  ...
  static basicCapitalList = {
    heads: [
      ...
      {
        label: '是否关联企业',
        value: 'isRelationCompany',
        type: 'isRelationCompany',
        _inList: { sort: false, search: true },
        show: true,
      },
    ],
    searches: [
      ...
      },
      {
        ...
        checkerId: 'flowId',
        type: 'select',
        options: { ref: 'vankeListTypesingle' },
        required: false,
        sortOrder: 7,
        show: true,
      },
      ...
      },
      {
        ...
        type: 'select',
        base: 'number',
        options: { ref: 'freezing' },
        required: false,
        sortOrder: 9,
        show: true,
      },
      {
        title: '实际上传发票与预录入是否一致',
        checkerId: 'isInvoiceFlag',
        base: 'number',
        type: 'select',
  ...
  static transactionFileList = {
    ...
    searches: [
      ...
      {
        title: '《付款确认书》',
        checkerId: 'statusFactoringPayConfirm',
        type: 'select',
        required: false,
        sortOrder: 14,
        show: true,
        options: { ref: 'vankeSelectFlag2' },
      },
      {
        title: '其他文件',
        checkerId: 'otherFile',
  ...
  static dueDiligenceList = {
    heads: [
      ...
      {
        label: '律所尽调状态',
        value: 'lawSurveyStatus',
        type: 'surveyStatus',
        show: true,
      },
      {
        label: '律所尽调意见',
        value: 'lawSurveyAdvise',
        type: 'surveyInfo',
        show: true,
      },
      {
        label: '管理人尽调状态',
        value: 'managerSurveyStatus',
        type: 'surveyStatus',
        show: true,
      },
      {
        label: '管理人尽调意见',
        value: 'managerSurveyAdvise',
        type: 'surveyInfo',
        show: true,
      },
    ],
    searches: [
      ...
      {
        title: '尽调状态',
        checkerId: 'surveyStatus',
        type: 'multiselect',
        options: { ref: 'allSurveyStatus' },
        required: false,
        sortOrder: 9,
        show: true,
      },
  ...
  static specialCapitalList = {
    heads: [
      ...
      {
        label: '特殊资产标记',
        value: 'isSpecialAsset',
        type: 'specialCapitalMark',
        show: true,
      },
      {
        label: '赎回/回购价格',
    ...
    searches: [
      ...
      {
        title: '特殊资产标记',
        checkerId: 'isSpecialAsset',
        base: 'number',
        type: 'select',
        options: { ref: 'specialCapitalMark' },
        required: false,
        sortOrder: 11,
        show: true,
      },
      {
        title: '处置状态',
        checkerId: 'disposeStatus',
        base: 'number',
        type: 'select',
        options: { ref: 'disposalStatus' },
        required: false,
        sortOrder: 12,
        show: true,
      },
    ...
    searches: {
      ...
      searches: [
        ...
        },
        {
          ...
          checkerId: 'operateId',
          type: 'select',
          options: { ref: 'operateType' },
          required: false,
          sortOrder: 2,
        },
        {
          title: '操作人',
          checkerId: 'operateUserName',
          type: 'text',
          required: false,
          sortOrder: 2,
        },
  ...
  static getTabConfig(
    ...
    tabConfig.level = 0;
    tabConfig[LevelEnum[0]] = ProjectManagerCapitalList.filterAuth(
  ...
  static filterAuth(
    ...
    if (Object.prototype.toString.call(authInfo) === '[object Object]') {
      for (const key of Object.keys(authInfo)) {
        authInfo[key] = ProjectManagerCapitalList.filterAuth(
          authInfo[key],
          agencyInfo,
          key,
          level
        ...
        .map((tabObj: any) => {
          ...
          if (LevelEnum[level] === 'tabList') {
            tabObj[LevelEnum[tabObj.level]].forEach((subObj: any) => {
              subObj.headText = [
                ...ProjectManagerCapitalList.headSearches[tabObj.value][
                  subObj.value
                ].heads,
              ];
              subObj.searches = [
          ...
          if (
            ...
            tabObj[LevelEnum[tabObj.level]] =
              ProjectManagerCapitalList.filterAuth(
                tabObj[LevelEnum[tabObj.level]],
                agencyInfo,
