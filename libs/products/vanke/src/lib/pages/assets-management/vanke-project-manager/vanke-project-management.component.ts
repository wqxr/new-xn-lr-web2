    ...
    public handleRowClick(item: any, btn: ButtonConfigModel, i: number) {
        ...
        switch (btn.operate) {
            ...
            case 'notice_manage':  // 提醒管理
                this.xn.router.navigate(['/vanke/assets-management/notice-manage'], {
                    queryParams: {
                        project_manage_id: item.project_manage_id,
                        projectName: item.projectName
                    }
  ...
  */
    ...
    private buildParams() {
        ...
        const params: any = {
            ...
            // beginTime: this.beginTime,
            // endTime: this.endTime,
            type: TabListEnum[this.defaultValue]
    ...
    setUpProject(types: number, paramsInfo?: any) {
        let type =TabListEnum[this.defaultValue];
        if (paramsInfo !== undefined && paramsInfo.headquarters === HeadquartersTypeEnum[1]) {
            ...
            .subscribe((v) => {
                ...
                if (v === null) {
                    ...
                    if (types === 2) {
                        ...
                        v.headquarters = HeadquartersTypeEnum[1];
