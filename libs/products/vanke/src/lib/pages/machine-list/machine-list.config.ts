...
export default class MachineIndexTabConfig {
  ...
  static MachineaccountTab = {
    heads: [
      ...
      // {
      //   label: '放款批次号', value: 'payBatch', type: 'text', _inList: {
      //     sort: false,
      //     search: false
      //   }
      // },
      ...
      {
        label: '可放款批次号', value: 'payBatch', type: 'text', _inList: {
          sort: false,
          search: true
        }},
    ...
    searches: [
      ...
      {
        title: '交易状态完成时间', checkerId: 'tradeTime', type: 'select-time',
        required: false, sortOrder: 7, options: { ref: 'vankeListTypesingle' }
      },
      ...
      { title: '付款银行', checkerId: 'fundingInfo', type: 'text', required: false },
      { title: '托管银行', checkerId: 'depositBank', type: 'text', required: false },
      {
        title: '可放款批次号', checkerId: 'isPayBatchNull', type: 'select-text',
        options: { ref: 'accountReceipts' }, required: false, sortOrder: 8
      },
      // { title: '可放款批次号是否为空', checkerId: 'isPayBatchNull', type: 'select', required: false, options: { ref: 'defaultRadio' }, },
      // { title: '可放款批次号', checkerId: 'payBatch', type: 'text', required: false },
          ...
          subTabList: [
            ...
            },
            {
              ...
              headText: [
                ...
                { label: '放款回单', value: 'loanReturn', type: 'file', },
                {
                  label: '付款确认书编号(总部致保理商)', value: 'payConfirmId', type: 'text', _inList: {
                    sort: false,
                    search: true
      ...
      tabList: [
        {
          ...
          subTabList: [
            ...
            },
            {
              ...
              {
                label: '放款回单', value: 'loanReturn', type: 'file', _inList: {
                  sort: false,
                  search: true
                },
              },
