...
* All rights reserved.
*
* @file：libs\products\vanke\src\lib\shared\components\flow\sub_vanke_system_check_reject.ts
* @summary：万科预审不通过流程
* @version: 1.0
* *************************************************************************
...
export class VankesystemCheck implements IFlowCustom {
    ...
    afterSubmitandGettip(svrConfig: any, formValue: any): Observable<any> {
        if (svrConfig.procedure.procedureId === 'review') {
            ...
            return this.xn.dragon.post('/sub_system/vanke_system/audit_refund_bill',
