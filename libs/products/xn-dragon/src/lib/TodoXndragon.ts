...
import { HeadquartersTypeEnum, applyFactoringTtype } from 'libs/shared/src/lib/config/select-options';
import { ProxyType } from 'libs/shared/src/lib/config/enum/common-enum';

/**
 *  首页代办
 */
export default class TodoXnDragon {
    ...
    static isProxy = 52;
    static headquarters = HeadquartersTypeEnum[8];
    static factoringAppId = applyFactoringTtype['深圳市香纳商业保理有限公司'];
