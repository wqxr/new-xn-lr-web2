...
export default class DragonsecondContractTemplateTab {
    // 二次转让合同模板列表
                    ...
                    subTabList: [
                        {
                            ...
                            searches: DragonsecondContractTemplateTab.secondContractTemplateList.searches,
                            params: 1,
                            headText: [...DragonsecondContractTemplateTab.secondContractTemplateList.heads],
                        }
                    ],
