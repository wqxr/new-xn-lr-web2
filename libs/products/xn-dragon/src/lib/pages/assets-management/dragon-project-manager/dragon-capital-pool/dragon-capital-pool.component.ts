...
export class DragonCapitalpoolComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    */
    ...
    navBack() {
        if (this.isMachineenter === true) {
            ...
            this.xn.router.navigate(['/xnlogan/assets-management/projectPlan-management'], {
                queryParams: {
    ...
    */
    ...
    viewProgress(mainFlowId) {
        this.xn.router.navigate([`xnlogan/main-list/detail/${mainFlowId}`]);
    }
    ...
    public handleRowClick(item: any, btn: ButtonConfigModel) {
        if (btn.operate === 'sub_start_survey') {
            ...
            if (!(rolesArr && rolesArr.length)) {
                ...
                this.xn.router.navigate([`/xnlogan/record/new/`],
                    {
                        queryParams: {
    ...
    public batchModify() {
        ...
        this.xn.router.navigate(['/xnlogan/capital-pool/batch-modify'], {
     ...
     */
    addTransaction() {
        this.xn.router.navigate([`/xnlogan/assets-management/enter-pool`], {
            queryParams: {
                ...
                if (x.data.isCapitalPoolSample) {
                    ...
                    XnModalUtils.openInViewContainer(this.xn, this.vcr, EditModalComponent, params).subscribe(v => {
                        if (v === null) {
                            ...
                            // 抽样页面
                            this.xn.router.navigate(['/xnlogan/assets-management/capital-sample'], {
                                queryParams: {
    ...
    // 数据分析
    dataAnalyse() {
        this.xn.router.navigate(['/xnlogan/assets-management/capital-data-analyse'], {
            queryParams: {
                totalCount: this.pageConfig.total,
                sumReceive: this.sumReceive,
                ...this.queryParams
