...
export class BatchModifyComponent implements OnInit {
    ...
    public goBack() {
        ...
        //     // 资产管理
        //     this.xn.router.navigate(['/xnlogan/vanke/capital-pool'], {
        //         queryParams: this.formCapitalPool
        //     });
        // } else if (this.isEnterPoor) {
        //     // 拟入池
        //     this.xn.router.navigate(['/xnlogan/vanke/enter-pool']);
        // } else {
    ...
    public viewProcess(item: any) {
        this.xn.router.navigate([`xnlogan/main-list/detail/${item}`]);
    }
