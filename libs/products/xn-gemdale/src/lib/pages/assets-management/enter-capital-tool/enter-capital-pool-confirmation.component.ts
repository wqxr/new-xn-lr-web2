...
export class XnGemdaleEnterpoolComponent implements OnInit {
    tabConfig: any;
    ...
    public isFirst = true;
    public headquarters = HeadquartersTypeEnum[2];
    fitProject = '';
    ...
    downLoadList: any[] = [];
    private defaultHeadquarter = HeadquartersTypeEnum[2];
    ...
    public exportCapital() {
        ...
        XnModalUtils.openInViewContainer(this.xn, this.vcr, CapitalPoolExportListModalComponent, params).subscribe(x => {
            ...
            this.xn.api.dragon.download('/sub_system/jd_system/jd_pool_excel_download', param).subscribe((v: any) => {
                this.xn.loading.close();
                this.xn.api.dragon.save(v._body, '所有交易清单.xlsx');
            }, () => {
                this.xn.loading.close();
            });
        });
