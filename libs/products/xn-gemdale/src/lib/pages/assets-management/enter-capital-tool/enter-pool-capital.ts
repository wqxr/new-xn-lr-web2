...
// 标准保理 - 交易列表
export default class XnGemdaleEnterPoolConfig {
    // 地产类ABS
            ...
            tabList: [
                {
                    ...
                    searches: XnGemdaleEnterPoolConfig.enterPoolList.searches,
                    headText: XnGemdaleEnterPoolConfig.enterPoolList.heads,
