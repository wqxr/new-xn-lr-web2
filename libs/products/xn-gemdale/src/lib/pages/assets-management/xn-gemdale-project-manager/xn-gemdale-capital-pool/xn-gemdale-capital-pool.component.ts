 ...
 * All rights reserved.
 *
 * @file：XnGemdaleCapitalpoolComponent
...
import { XnGemdaleSingleSearchListModalComponent, SingleListParamInputModel } from '../../../../share/modal/single-searchList-modal.component';
import ProjectManagerCapitalList from './xn-gemdale-capital-pool';
declare const moment: any;
declare const $: any;

@Component({
    selector: 'xn-gemdale-capital-management',
    templateUrl: `./xn-gemdale-capital-pool.component.html`,
    styleUrls: ['./xn-gemdale-capital-pool.component.css']
})
export class XnGemdaleCapitalpoolComponent implements OnInit, AfterViewInit, OnDestroy {
    tabConfig: any;  //表格配置
    ...
    */
    ...
    navBack() {
        if (this.isMachineenter === true) {
            ...
            this.xn.router.navigate(['/xn-gemdale/assets-management/projectPlan-management'], {
                queryParams: {
    ...
    */
    ...
    public batchModify() {
        ...
        this.xn.router.navigate(['/xn-gemdale/batch-modify'], {
     ...
     */
    addTransaction() {
        this.xn.router.navigate([`/xn-gemdale/assets-management/enter-pool`], {
            queryParams: {
                ...
                if (x.data.isCapitalPoolSample) {
                    ...
                    XnModalUtils.openInViewContainer(this.xn, this.vcr, EditModalComponent, params).subscribe(v => {
                        if (v === null) {
                            ...
                            //抽样页面
                            this.xn.router.navigate(['/xn-gemdale/assets-management/capital-sample'], {
                                queryParams: {
    ...
    // 数据分析
    dataAnalyse() {
        this.xn.router.navigate(['/xn-gemdale/assets-management/capital-data-analyse'], {
            queryParams: {
                totalCount: this.pageConfig.total,
                sumReceive: this.sumReceive,
                ...this.queryParams
