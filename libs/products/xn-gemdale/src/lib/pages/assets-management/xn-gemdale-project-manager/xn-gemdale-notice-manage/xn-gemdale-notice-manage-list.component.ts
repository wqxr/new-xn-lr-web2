...
@Component({
    selector: 'xn-gemdale-notice-manage',
    templateUrl: `./xn-gemdale-notice-manage-list.component.html`,
    styles: [
        `
        .item-box {
            position: relative;
...
export class XnGemdaleNoticeManageComponent implements OnInit {
