...
@Component({
    selector: 'xn-gemdale-project-management-component',
    templateUrl: `./xn-gemdale-project-management.component.html`,
    styles: [`
    .item-box {
        position: relative;
        display: flex;
...
export class XnGemdaleProjectmanageComponent implements OnInit {
    tabConfig: any;
    ...
    public handleRowClick(item: any, btn: ButtonConfigModel, i: number) {
        ...
        switch (btn.operate) {
            ...
            case 'notice_manage':  // 提醒管理
                this.xn.router.navigate(['/xn-gemdale/assets-management/notice-manage'], {
                    queryParams: {
                        project_manage_id: item.project_manage_id,
                        projectName: item.projectName
                    }
