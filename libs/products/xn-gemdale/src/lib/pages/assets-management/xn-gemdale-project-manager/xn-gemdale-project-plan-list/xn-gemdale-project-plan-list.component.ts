...
import ProjectManagerplanList from './xn-gemdale-project-plan';

declare const moment: any;

@Component({
    selector: 'xn-gemdale-project-plan-list',
    templateUrl: `./xn-gemdale-project-plan-list.component.html`,
    styles: [`
    .item-box {
        position: relative;
        display: flex;
...
export class XnGemdaleProjectmanagePlanComponent implements OnInit {
    tabConfig: any;
    ...
    ngOnInit(): void {
        this.router.queryParams.subscribe(x => {
            this.title = '项目管理-金地-香纳>' + x.title + '>' + x.projectName + '-' + x.headquarters;
  ...
  */
     ...
     */
    navBack() {
        this.xn.router.navigate(['/xn-gemdale/assets-management/project-list'], {
            queryParams: {
