      ...
      },
      {
        ...
        templateOptions: {
          ...
          nzRanges: {
            ...
            近180天: [
              moment().subtract(180, 'days').startOf('day').toDate(),
              moment().endOf('day').toDate(),
            ],
            近365天: [
              moment().subtract(365, 'days').startOf('day').toDate(),
              moment().endOf('day').toDate(),
            ],
            这个月: [
              moment().startOf('month').toDate(),
              ...
              edit: {
                headButtons: [
                  ...
                  },
                  {
                    ...
                    operate: 'export_data',
                    post_url:
                      '/sub_system/jd_system/jd_repayment_excel_download',
                    disabled: true,
                  },
                ],
              },
          ...
          subTabList: [
            {
              ...
              showFields: [
                ...RepaymentConfigList.commonConfig.showFields,
                {
                  className: 'ant-col ant-col-md-8 ant-col-sm-24',
                  key: 'jdPaybackTime',
                  type: 'date-range-picker',
              ...
              headText: [
                ...RepaymentConfigList.commonConfig.heads,
                {
                  title: '金地还款时间',
                  index: 'jdPaybackTime',
                  render: 'dateTpl',
