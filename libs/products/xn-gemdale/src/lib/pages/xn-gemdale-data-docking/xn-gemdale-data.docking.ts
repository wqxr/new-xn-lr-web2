...
// 标准保理 -金地接口数据列表
export default class XnGemdaleDataDockingConfig {
  // 地产类ABS
          ...
          subTabList: [
            {
              ...
              searches: [...XnGemdaleDataDockingConfig.dataLockinglist.searches],
              params: 0,
              searchNumber: 14,
              headNumber: 13,
              headText: [...XnGemdaleDataDockingConfig.dataLockinglist.heads],
            },
          ],
          ...
          subTabList: [
            {
              ...
              searches: [
                ...XnGemdaleDataDockingConfig.dataLockinglist.searches,
              ...
              headText: [
                ...
                ...XnGemdaleDataDockingConfig.dataLockinglist.heads],
            },
          ],
          post_url: '/sub_system/jd_system/jd_financing_list'
        },
