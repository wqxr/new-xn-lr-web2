 ...
 *  首页代办
 */
export default class TodoXnVanke {
        ...
        rowButtons: [
            {
                ...
                click: (base: DragonCommBase, record, xn, vcr) => {
                    ...
                    record.factoringAppId = TodoXnVanke.factoringAppId
                    record.isProxy = 53
                    record.proxyType = record.proxyType === ProxyType.AVENGER ? ProxyType.AVENGER : ProxyType.XN_VANKE;
