...
export default class DragonpaymentDownloadTabConfig {
  ...
  static dragonDownLoadLists = {
    ...
    searches: [
      ...
      { title: '交易状态', checkerId: 'flowId', type: 'select', options: { ref: 'vankeQrsStyle' }, required: false, sortOrder: 25 },
          ...
          subTabList: [
            {
              ...
              { label: '买方确认函（万科电子版）', value: 'vankeBuyerFile', type: 'vankeBuyerFile' },
