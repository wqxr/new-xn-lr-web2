                    ...
                    subTabList: [
                        {
                            ...
                            {
                                title: '电子签章状态', checkerId: 'signStatus', type: 'select', required: false, sortOrder: 15,
                                options: { ref: 'vankeDockSignStatus' }
                            },
                            ],
                            headText: [...ApprovallistIndexTabConfig.normalbusiness.heads,
                            { label: '电子签章状态', value: 'signStatus', type: 'signStatus' },
                            ],
                        },
                    ...
                    subTabList: [
                        {
                            ...
                            {
                                title: '电子付确下载状态', checkerId: 'verifyPayConfimStatus', type: 'select', options: { ref: 'verifyPayConfimStatus' },
                                required: false, sortOrder: 21
                            },
                            ],
                            headText: [...ApprovallistIndexTabConfig.readySigncontract.heads,
                                ...
                                { label: '转让价款', value: 'changePrice', type: 'receivable' },
                            {
                                label: '电子付确下载状态', value: 'verifyPayConfimStatus', type: 'verifyPayConfimStatus'
                            },
                            ],
 ...
 */
function arraySplice(array: ListHeadsFieldOutputModel[], ele: ListHeadsFieldOutputModel, positionKeyWord: string, position: string) {
