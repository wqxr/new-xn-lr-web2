...
export default class ProjectManagerCapitalList {
    ...
    static basicCapitalList = {
        ...
        searches: [
            ...
            { title: '交易状态', checkerId: 'flowId', type: 'select', options: { ref: 'vankeListTypesingle' }, required: false, sortOrder: 7, show: true },
    ...
    static transactionFileList = {
        heads: [
            ...
            { label: '买方确认函（万科电子版）', value: 'vankeBuyerFile', type: 'file', show: true },
