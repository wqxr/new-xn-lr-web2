...
export default class ZsGemdaleApprovalListIndexTabConfig {
  // 交易列表 -采购融资，默认配置
          ...
          subTabList: [
            {
              ...
              searches: [...ZsGemdaleApprovalListIndexTabConfig.normalbusiness.searches,

              ],
              headText: [...ZsGemdaleApprovalListIndexTabConfig.normalbusiness.heads,
              { label: '付款申请表', value: 'receivetable', type: 'contract' },
              ],
            },

            {
              ...
              searches: [...ZsGemdaleApprovalListIndexTabConfig.SpecialBusinesslist.searches,
              ],
              headText: [...ZsGemdaleApprovalListIndexTabConfig.SpecialBusinesslist.heads,
              { label: '付款申请表', value: 'receivetable', type: 'contract' },
              ],
            },
          ],
          ...
          subTabList: [
            {
              ...
              searches: ZsGemdaleApprovalListIndexTabConfig.approvalBusinesslist.searches,
              headText: [...ZsGemdaleApprovalListIndexTabConfig.approvalBusinesslist.heads,
          ...
          subTabList: [
            {
              ...
              searches: [...ZsGemdaleApprovalListIndexTabConfig.readySigncontract.searches,

              ],
              headText: [...ZsGemdaleApprovalListIndexTabConfig.readySigncontract.heads,
              { label: '起息日', value: 'valueDate', type: 'date' },
              { label: '转让价款', value: 'changePrice', type: 'receivable' },
          ...
          subTabList: [
            {
              ...
              searches: [...ZsGemdaleApprovalListIndexTabConfig.searcherCommon.searches,
              { title: '转让价款', checkerId: 'changePrice', type: 'text', required: false, sortOrder: 15 },
              ],
              headText: [...ZsGemdaleApprovalListIndexTabConfig.headscommon.heads,
