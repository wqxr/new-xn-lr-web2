...
// 标准保理 - 交易列表
export default class ZsGemdaleEnterPoolConfig {
    // 地产类ABS
            ...
            tabList: [
                {
                    ...
                    searches: ZsGemdaleEnterPoolConfig.enterPoolList.searches,
                    headText: ZsGemdaleEnterPoolConfig.enterPoolList.heads,
