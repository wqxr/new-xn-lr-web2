 ...
 * All rights reserved.
 *
 * @file：ZsGemdaleCapitalpoolComponent
...
import ProjectManagerCapitalList from './zs-gemdale-capital-pool';
declare const moment: any;
declare const $: any;

@Component({
    selector: 'zs-gemdale-capital-management',
    templateUrl: `./zs-gemdale-capital-pool.component.html`,
    styleUrls: ['./zs-gemdale-capital-pool.component.css']
})
export class ZsGemdaleCapitalpoolComponent implements OnInit, AfterViewInit, OnDestroy {
    tabConfig: any;  //表格配置
    ...
    */
    ...
    navBack() {
        if (this.isMachineenter === true) {
            ...
            this.xn.router.navigate(['/zs-gemdale/assets-management/projectPlan-management'], {
                queryParams: {
    ...
    public handleHeadClick(paramBtnOperate: ButtonConfigModel) {
        if (paramBtnOperate.operate === 'generate_Contract') {
            ...
            XnModalUtils.openInViewContainer(this.xn, this.vcr, ZsGemdaleSingleSearchListModalComponent, params).subscribe(v => {
            });
    ...
    */
    ...
    public batchModify() {
        ...
        this.xn.router.navigate(['/zs-gemdale/batch-modify'], {
     ...
     */
    addTransaction() {
        this.xn.router.navigate([`/zs-gemdale/assets-management/enter-pool`], {
            queryParams: {
                ...
                if (x.data.isCapitalPoolSample) {
                    ...
                    XnModalUtils.openInViewContainer(this.xn, this.vcr, EditModalComponent, params).subscribe(v => {
                        if (v === null) {
                            ...
                            //抽样页面
                            this.xn.router.navigate(['/zs-gemdale/assets-management/capital-sample'], {
                                queryParams: {
    ...
    // 数据分析
    dataAnalyse() {
        this.xn.router.navigate(['/zs-gemdale/assets-management/capital-data-analyse'], {
            queryParams: {
                totalCount: this.pageConfig.total,
                sumReceive: this.sumReceive,
                ...this.queryParams
