...
@Component({
    selector: 'zs-gemdale-notice-manage',
    templateUrl: `./zs-gemdale-notice-manage-list.component.html`,
    styles: [
        `
        .item-box {
            position: relative;
...
export class ZsGemdaleNoticeManageComponent implements OnInit {
