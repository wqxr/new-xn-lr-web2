...
@Component({
    selector: 'zs-gemdale-project-management-component',
    templateUrl: `./zs-gemdale-project-management.component.html`,
    styles: [`
    .item-box {
        position: relative;
        display: flex;
...
export class ZsGemdaleProjectmanageComponent implements OnInit {
    tabConfig: any;
    ...
    public handleRowClick(item: any, btn: ButtonConfigModel, i: number) {
        ...
        switch (btn.operate) {
            ...
            case 'notice_manage':  // 提醒管理
                this.xn.router.navigate(['/zs-gemdale/assets-management/notice-manage'], {
                    queryParams: {
                        project_manage_id: item.project_manage_id,
                        projectName: item.projectName
                    }
