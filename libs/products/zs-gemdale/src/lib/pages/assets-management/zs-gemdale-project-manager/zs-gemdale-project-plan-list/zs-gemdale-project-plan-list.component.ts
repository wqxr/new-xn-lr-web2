...
import ProjectManagerplanList from './zs-gemdale-project-plan';

declare const moment: any;

@Component({
    selector: 'zs-gemdale-project-plan-list',
    templateUrl: `./zs-gemdale-project-plan-list.component.html`,
    styles: [`
    .item-box {
        position: relative;
        display: flex;
...
export class ZsGemdaleProjectmanagePlanComponent implements OnInit {
    tabConfig: any;
    ...
    ngOnInit(): void {
        this.router.queryParams.subscribe(x => {
            this.title = '项目管理-金地-前海中晟>' + x.title + '>' + x.projectName + '-' + x.headquarters;
    ...
    getPlan(paramInfo: any) {
        ...
        this.xn.router.navigate(['/zs-gemdale/assets-management/capital-pool'], {
            queryParams: {
                title: this.title,
  ...
  */
     ...
     */
    navBack() {
        this.xn.router.navigate(['/zs-gemdale/assets-management/project-list'], {
            queryParams: {
