...
import { ZsGemdaleSingleSearchListModalComponent } from '../../share/modal/single-searchList-modal.component';
import { ZsGemdalegetCustomListComponent } from '../../share/modal/custom-list-modal.component';
import { ZsGemdalegetCustomFiledComponent } from '../../share/modal/custom-field-modal.component';
...
declare const $: any;
@Component({
  // selector: 'zs-gemdale-data-docking',
  templateUrl: `./zs-gemdale-data-docking.component.html`,
  styles: [`
    .item-box {
        position: relative;
        display: flex;
...
export class ZsGemdaleDatalockingComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  public handleHeadClick(paramBtnOperate: ButtonConfigModel) {
    if (paramBtnOperate.operate === 'custom_search') {
      ...
      XnModalUtils.openInViewContainer(this.xn, this.vcr, ZsGemdalegetCustomFiledComponent, params).subscribe(v => {
        if (v && v.action === 'ok') {
      ...
      XnModalUtils.openInViewContainer(this.xn, this.vcr, ZsGemdalegetCustomListComponent, params).subscribe(v => {
        if (v && v.action === 'ok') {
