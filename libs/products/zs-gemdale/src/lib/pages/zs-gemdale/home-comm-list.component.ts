 ...
 */
@Component({
  selector: 'zs-gemdale-home-comm-list-component',
  templateUrl: './home-comm-list.component.html',
  styleUrls: [
    './home-comm-list.component.css'
  ]
})
export class ZsGemdaleHomeCommListComponent extends CommonPage implements OnInit {
  @Input() supers: any;
  total = 0;
  rows: any[] = [];
  words = '';
  ...
  public viewProcess(paramMainFlowId: string) {
    this.xn.router.navigate([`zs-gemdale/main-list/detail/${paramMainFlowId}`]);
  }
