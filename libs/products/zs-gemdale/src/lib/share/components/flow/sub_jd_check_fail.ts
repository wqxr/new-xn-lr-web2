...
import { ZsGemdaleSingleSearchListModalComponent, SingleListParamInputModel } from '../../modal/single-searchList-modal.component';
            ...
            return this.xn.dragon.post('/sub_system/jd_system/jd_check_fail',
                ...
                .pipe(map(x => {
                    if (x.ret === 0 && x.data.length) {
                        ...
                        return {
                            action: 'modal',
                            modal: ZsGemdaleSingleSearchListModalComponent,
                            params
                        };
                    } else {
                        return of(null);
