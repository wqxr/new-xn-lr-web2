...
@Component({
    selector: 'zs-gemdale-business-related',
    templateUrl: './zs-gemdale-business-related.component.html',
    styles: [
        `
            .table {
                font-size: 13px;
...
export class ZsGemdaleBusinessComponent implements OnInit {
    ...
    viewRecord(record: string, type: string) {
        if (type && type === 'avenger') {
            ...
            this.xn.router.navigate([`/zs-gemdale/record/todo/view/${record}`]);
        }
    }
