...
export default class DragonCommBase {
    ...
    onDefaultList(params) {
        if (this.superConfig.headquarters?.includes('龙光')) {
            params.headquarters = '龙光';
        } else {
            params.headquarters = this.superConfig.headquarters;
        }
        params.factoringAppId = this.superConfig?.factoringAppId;
