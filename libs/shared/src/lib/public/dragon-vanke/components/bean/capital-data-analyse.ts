 ...
 *
 * @file：IndexTabConfig
 * @summary：项目管理-基础资产-数据分析页面checker配置
 * @version: 1.0
 * **********************************************************************
...
export default class CapitalcapitalDataAnalyseConfig {
    // 数据分析页面
    static capitalPoolOverview = {
        checkers: [
            { title: '资产池名称', checkerId: 'capitalPoolName', type: 'special-text', required: false, value: '', placeholder: '' },
            { title: '加权平均剩余期限（天）', checkerId: 'paymentDaysAverage', type: 'special-text', required: false, value: '', placeholder: '' },
            { title: '应收账款余额总计（元）', checkerId: 'receiveSum', type: 'special-text', required: false, value: '', placeholder: '' },
            { title: '应收账款笔数（笔）', checkerId: 'count', type: 'special-text', required: false, value: '', placeholder: '' },
            { title: '项目公司户数（户）', checkerId: 'projectCount', type: 'special-text', required: false, value: '', placeholder: '' },
            { title: '供应商数量（个）', checkerId: 'debtUnitCount', type: 'special-text', required: false, value: '', placeholder: '' },
            { title: '单笔应收账款最小余额（元）', checkerId: 'receiveMin', type: 'special-text', required: false, value: '', placeholder: '' },
            { title: '单笔应收账款最大余额（元）', checkerId: 'receiveMax', type: 'special-text', required: false, value: '', placeholder: '' },
    ...
    static contractTypeList = {
        heads: [
            { label: '应收账款种类', value: 'contractType', type: 'contractType', _inList: { sort: false, search: true }, show: true, width: '25%' },
            ...
            { label: '余额占比（%）', value: 'surplusRate', type: 'rate', _inList: { sort: true, search: true }, show: true, width: '25%' },
    ...
    static receiveList = {
        heads: [
            { label: '金额', value: 'receiveType', type: 'receiveType', _inList: { sort: false, search: true }, show: true, width: '25%' },
            { label: '笔数（笔）', value: 'number', _inList: { sort: false, search: true }, show: true, width: '25%' },
            { label: '笔数占比（%）', value: 'countRate', type: 'rate', _inList: { sort: true, search: true }, show: true, width: '50%' }
        ] as ListHeadsFieldOutputModel[],
    };
    ...
    static paymentDaysList = {
        heads: [
            { label: '剩余账期', value: 'paymentDays', type: 'paymentDays', _inList: { sort: false, search: true }, show: true, width: '25%' },
    ...
    static tableListAll = [{
        ...
        tableConfig: CapitalcapitalDataAnalyseConfig.contractTypeList,
    ...
    },
    {
        ...
        tableConfig: CapitalcapitalDataAnalyseConfig.receiveList,
        url: '/sample/pool_report',
        urlType: 'dragon',
        data: [],
        // 统计行配置
    ...
    },
    {
        ...
        tableConfig: CapitalcapitalDataAnalyseConfig.projectAreaList,
        url: '/sample/pool_report',
        urlType: 'dragon',
        data: [],
        // 统计行配置
    ...
    },
    {
        ...
        tableConfig: CapitalcapitalDataAnalyseConfig.debtUnitAreaList,
        url: '/sample/pool_report',
        urlType: 'dragon',
        data: [],
        // 统计行配置
    ...
    },
    {
        ...
        tableConfig: CapitalcapitalDataAnalyseConfig.projectBusinessList,
        url: '/sample/pool_report',
        urlType: 'dragon',
        data: [],
        // 统计行配置
    ...
    },
    {
        ...
        tableConfig: CapitalcapitalDataAnalyseConfig.paymentDaysList,
        url: '/sample/pool_report',
        urlType: 'dragon',
        data: [],
        // 统计行配置
    ...
    },
    {
        ...
        tableConfig: CapitalcapitalDataAnalyseConfig.debtUnitList,
        url: '/sample/pool_report',
        urlType: 'dragon',
        data: [],
        // 统计行配置
    ...
    },
    {
        ...
        tableConfig: CapitalcapitalDataAnalyseConfig.projectList,
        url: '/sample/pool_report',
        urlType: 'dragon',
        data: [],
        // 统计行配置
    ...
    static setRowsValue(params: { [key: string]: any }): any {
        CapitalcapitalDataAnalyseConfig.capitalPoolOverview.checkers.forEach((obj) => {
            if (params.hasOwnProperty(obj.checkerId)) {
                obj.value = params[obj.checkerId];
            }
        });
        return CapitalcapitalDataAnalyseConfig.capitalPoolOverview;
    }
    ...
    static setTableValue(params: { [key: string]: any }, rateCount: { receiveSum: number, count: number }): any {
        CapitalcapitalDataAnalyseConfig.tableListAll.forEach((obj) => {
            if (params.hasOwnProperty(obj.checkerId)) {
                let key1 = '';
                let key2 = '';
                let key3 = '';
        ...
        return CapitalcapitalDataAnalyseConfig.tableListAll;
    }

    static getConfig(name: string, type: string) {
        return CapitalcapitalDataAnalyseConfig[name][type];
    }
}
