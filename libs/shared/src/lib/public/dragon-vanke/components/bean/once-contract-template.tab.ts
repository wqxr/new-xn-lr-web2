...
export default class onceContractTemplateTab {
    ...
    static contractTemplate = {
        title: '合同模板选择',
        heads: [
            { label: '适用总部公司', value: 'headquarters', },  // headquarters
        ...
        searches: [
            {
                title: '适用总部公司', checkerId: 'headquarters', type: 'select',
                options: { ref: "enterprise_dragon3", readonly: true }, required: false, number: 1
            },
            { title: '合同模板', checkerId: 'templateName', type: 'text', required: false, number: 2 },
