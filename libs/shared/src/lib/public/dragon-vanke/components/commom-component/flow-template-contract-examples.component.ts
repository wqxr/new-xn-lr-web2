...
@Component({
    selector: 'flow-contract-template',
    templateUrl: './flow-template-contract-examples.component.html',
    styles: [
        `
        .helpUl {
            padding-left:20px;
...
export class FlowtemplateContractExampleComponent implements OnInit {
