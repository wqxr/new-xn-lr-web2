import { Component, OnInit, ElementRef, Input, ChangeDetectionStrategy, ViewContainerRef, AfterViewInit, OnDestroy } from '@angular/core';
...
// 查看二维码checker项
@DynamicForm({ type: 'table-common', formModule: 'dragon-input' })
export class VankeTableInfoInputComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        if (!!this.row.value) {
            this.datavalue = XnUtils.parseObject(this.row.value, []);
        }
