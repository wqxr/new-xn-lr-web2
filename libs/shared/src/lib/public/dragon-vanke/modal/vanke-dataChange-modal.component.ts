...
import VankeDataChangeList from '../../../common/dragon-vanke/vanke-dataChange';
import { ModalComponent, ModalSize } from '../../../common/modal/components/modal';
import { XnModalUtils } from '../../../common/xn-modal-utils';
import { SubTabListOutputModel, TabConfigModel, TabListOutputModel } from '../../../config/list-config-model';
...
@Component({
    ...
    selector: 'vanke-dataChange-modal',
    styles: [`
        .modal-title{
            height:25px;
        }
...
export class VankeDataChangeModalComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    public viewMore(paramItem: any[]) {
        ...
        const params: SingleListParamInputModel = {
            ...
            heads: [
                ...
                { label: '转让金额', value: 'invTransAmt', type: 'money' },
