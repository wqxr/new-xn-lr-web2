...
import { acceptedRoutes } from 'libs/shared/src/lib/config/reuse-routes';
...
export class CustomReuseStrategy implements RouteReuseStrategy {
     ...
     */
    storedRoutes: { [key: string]: RouteStorageObject } = {} as any;

    /**
     * Clear cache component instance
     */
    clear() {
        this.storedRoutes = {} as any;
    }
    ...
    shouldAttach(route: ActivatedRouteSnapshot): boolean {
        ...
        if (canAttach) {
            ...
            const handle = this.storedRoutes[route.routeConfig.path].handle as any;
            if (
                handle &&
                handle.componentRef &&
